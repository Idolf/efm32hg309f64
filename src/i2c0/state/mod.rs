...
#[inline]     pub fn is_idle(&self) -> bool {
    ...
    #[inline]
#[inline]     pub fn is_wait(&self) -> bool {
        *self == STATER::WAIT
    }
...
#[inline]     pub fn is_start(&self) -> bool {
    ...
    #[inline]
#[inline]     pub fn is_addr(&self) -> bool {
        *self == STATER::ADDR
    }
    #[doc = "Checks if the value of the field is `ADDRACK`"]
    #[inline]
#[inline]     pub fn is_addrack(&self) -> bool {
        *self == STATER::ADDRACK
    }
    #[doc = "Checks if the value of the field is `DATA`"]
    #[inline]
#[inline]     pub fn is_data(&self) -> bool {
        *self == STATER::DATA
    }
    #[doc = "Checks if the value of the field is `DATAACK`"]
    #[inline]
#[inline]     pub fn is_dataack(&self) -> bool {
        *self == STATER::DATAACK
    }
}
impl R {
...
#[inline]     pub fn master(&self) -> MASTERR {
    ...
    #[inline]
#[inline]     pub fn transmitter(&self) -> TRANSMITTERR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 2;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn nacked(&self) -> NACKEDR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 3;
            ((self.bits >> OFFSET) & MASK as u32) != 0
