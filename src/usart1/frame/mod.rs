...
#[inline]     pub fn bits(&self) -> u8 {
        match *self {
            ...
            DATABITSR::ELEVEN => 8,
            DATABITSR::TWELVE => 9,
            DATABITSR::THIRTEEN => 10,
            DATABITSR::FOURTEEN => 11,
            DATABITSR::FIFTEEN => 12,
            DATABITSR::SIXTEEN => 13,
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> DATABITSR {
        match value {
            1 => DATABITSR::FOUR,
            2 => DATABITSR::FIVE,
            3 => DATABITSR::SIX,
...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> PARITYR {
        match value {
            0 => PARITYR::NONE,
            2 => PARITYR::EVEN,
            3 => PARITYR::ODD,
...
#[inline]     pub fn is_none(&self) -> bool {
    ...
    #[inline]
#[inline]     pub fn is_even(&self) -> bool {
        *self == PARITYR::EVEN
    }
    #[doc = "Checks if the value of the field is `ODD`"]
    #[inline]
#[inline]     pub fn is_odd(&self) -> bool {
        *self == PARITYR::ODD
    }
}
...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> STOPBITSR {
        match value {
            0 => STOPBITSR::HALF,
            1 => STOPBITSR::ONE,
    ...
    #[inline]
#[inline]     pub fn is_half(&self) -> bool {
        *self == STOPBITSR::HALF
    }
    #[doc = "Checks if the value of the field is `ONE`"]
    #[inline]
#[inline]     pub fn is_one(&self) -> bool {
        *self == STOPBITSR::ONE
    }
    #[doc = "Checks if the value of the field is `ONEANDAHALF`"]
    #[inline]
#[inline]     pub fn is_oneandahalf(&self) -> bool {
        *self == STOPBITSR::ONEANDAHALF
    }
    #[doc = "Checks if the value of the field is `TWO`"]
    #[inline]
#[inline]     pub fn is_two(&self) -> bool {
        *self == STOPBITSR::TWO
    }
}
...
impl<'a> _DATABITSW<'a> {
    ...
    #[inline]
#[inline]     pub fn variant(self, variant: DATABITSW) -> &'a mut W {
        unsafe { self.bits(variant._bits()) }
    }
    #[doc = "Each frame contains 4 data bits"]
    #[inline]
#[inline]     pub fn four(self) -> &'a mut W {
        self.variant(DATABITSW::FOUR)
    }
    #[doc = "Each frame contains 5 data bits"]
    #[inline]
#[inline]     pub fn five(self) -> &'a mut W {
        self.variant(DATABITSW::FIVE)
    }
    #[doc = "Each frame contains 6 data bits"]
    #[inline]
#[inline]     pub fn six(self) -> &'a mut W {
        self.variant(DATABITSW::SIX)
    }
    #[doc = "Each frame contains 7 data bits"]
    #[inline]
#[inline]     pub fn seven(self) -> &'a mut W {
        self.variant(DATABITSW::SEVEN)
    }
    #[doc = "Each frame contains 8 data bits"]
    #[inline]
#[inline]     pub fn eight(self) -> &'a mut W {
        self.variant(DATABITSW::EIGHT)
    }
    #[doc = "Each frame contains 9 data bits"]
    #[inline]
#[inline]     pub fn nine(self) -> &'a mut W {
        self.variant(DATABITSW::NINE)
    }
    #[doc = "Each frame contains 10 data bits"]
    #[inline]
#[inline]     pub fn ten(self) -> &'a mut W {
        self.variant(DATABITSW::TEN)
    }
    #[doc = "Each frame contains 11 data bits"]
    #[inline]
#[inline]     pub fn eleven(self) -> &'a mut W {
        self.variant(DATABITSW::ELEVEN)
    }
    #[doc = "Each frame contains 12 data bits"]
    #[inline]
#[inline]     pub fn twelve(self) -> &'a mut W {
        self.variant(DATABITSW::TWELVE)
    }
    #[doc = "Each frame contains 13 data bits"]
    #[inline]
#[inline]     pub fn thirteen(self) -> &'a mut W {
        self.variant(DATABITSW::THIRTEEN)
    }
    #[doc = "Each frame contains 14 data bits"]
    #[inline]
#[inline]     pub fn fourteen(self) -> &'a mut W {
        self.variant(DATABITSW::FOURTEEN)
    }
    #[doc = "Each frame contains 15 data bits"]
    #[inline]
#[inline]     pub fn fifteen(self) -> &'a mut W {
        self.variant(DATABITSW::FIFTEEN)
    }
    #[doc = "Each frame contains 16 data bits"]
    #[inline]
#[inline]     pub fn sixteen(self) -> &'a mut W {
...
impl<'a> _PARITYW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
#[inline]     pub fn variant(self, variant: PARITYW) -> &'a mut W {
        unsafe { self.bits(variant._bits()) }
    }
    #[doc = "Parity bits are not used"]
    #[inline]
#[inline]     pub fn none(self) -> &'a mut W {
    ...
    #[doc = "Even parity are used. Parity bits are automatically generated and checked by hardware."]
    #[inline]
#[inline]     pub fn even(self) -> &'a mut W {
        self.variant(PARITYW::EVEN)
    }
    #[doc = "Odd parity is used. Parity bits are automatically generated and checked by hardware."]
    #[inline]
#[inline]     pub fn odd(self) -> &'a mut W {
...
impl<'a> _STOPBITSW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
#[inline]     pub fn variant(self, variant: STOPBITSW) -> &'a mut W {
        {
    ...
    #[doc = "The transmitter generates a half stop bit. Stop-bits are not verified by receiver"]
    #[inline]
#[inline]     pub fn half(self) -> &'a mut W {
        self.variant(STOPBITSW::HALF)
    }
    #[doc = "One stop bit is generated and verified"]
    #[inline]
#[inline]     pub fn one(self) -> &'a mut W {
        self.variant(STOPBITSW::ONE)
    }
    #[doc = "The transmitter generates one and a half stop bit. The receiver verifies the first stop bit"]
    #[inline]
#[inline]     pub fn oneandahalf(self) -> &'a mut W {
        self.variant(STOPBITSW::ONEANDAHALF)
    }
    #[doc = "The transmitter generates two stop bits. The receiver checks the first stop-bit only"]
    #[inline]
#[inline]     pub fn two(self) -> &'a mut W {
...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn databits(&self) -> DATABITSR {
        DATABITSR::_from({
            const MASK: u8 = 15;
            const OFFSET: u8 = 0;
    ...
    #[inline]
#[inline]     pub fn parity(&self) -> PARITYR {
        PARITYR::_from({
            const MASK: u8 = 3;
            const OFFSET: u8 = 8;
            ((self.bits >> OFFSET) & MASK as u32) as u8
    ...
    #[inline]
#[inline]     pub fn stopbits(&self) -> STOPBITSR {
        STOPBITSR::_from({
            const MASK: u8 = 3;
            const OFFSET: u8 = 12;
            ((self.bits >> OFFSET) & MASK as u32) as u8
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bits 0:3 - Data-Bit Mode"]
    #[inline]
#[inline]     pub fn databits(&mut self) -> _DATABITSW {
        _DATABITSW { w: self }
    }
    #[doc = "Bits 8:9 - Parity-Bit Mode"]
    #[inline]
#[inline]     pub fn parity(&mut self) -> _PARITYW {
        _PARITYW { w: self }
    }
    #[doc = "Bits 12:13 - Stop-Bit Mode"]
    #[inline]
#[inline]     pub fn stopbits(&mut self) -> _STOPBITSW {
        _STOPBITSW { w: self }
    }
}
