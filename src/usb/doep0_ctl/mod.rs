...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> EPTYPER {
        match value {
            0 => EPTYPER::CONTROL,
            1 => EPTYPER::ISO,
            2 => EPTYPER::BULK,
...
impl<'a> _EPTYPEW<'a> {
    ...
    #[inline]
#[inline]     pub fn variant(self, variant: EPTYPEW) -> &'a mut W {
        {
    ...
    #[doc = "Control Endpoint."]
    #[inline]
#[inline]     pub fn control(self) -> &'a mut W {
        self.variant(EPTYPEW::CONTROL)
    }
    #[doc = "Isochronous Endpoint."]
    #[inline]
#[inline]     pub fn iso(self) -> &'a mut W {
        self.variant(EPTYPEW::ISO)
    }
    #[doc = "Bulk Endpoint."]
    #[inline]
#[inline]     pub fn bulk(self) -> &'a mut W {
        self.variant(EPTYPEW::BULK)
    }
    #[doc = "Interrupt Endpoint."]
    #[inline]
#[inline]     pub fn int(self) -> &'a mut W {
...
#[inline]     pub fn mps(&self) -> MPSR {
    ...
    #[inline]
#[inline]     pub fn usbactep(&self) -> USBACTEPR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 15;
    ...
    #[inline]
#[inline]     pub fn dpideof(&self) -> DPIDEOFR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 16;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn naksts(&self) -> NAKSTSR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 17;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn eptype(&self) -> EPTYPER {
        EPTYPER::_from({
            const MASK: u8 = 3;
            const OFFSET: u8 = 18;
...
#[inline]     pub fn snp(&self) -> SNPR {
    ...
    #[inline]
#[inline]     pub fn stall(&self) -> STALLR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 21;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn epdis(&self) -> EPDISR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 30;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn epena(&self) -> EPENAR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 31;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bits 0:10 - Maximum Packet Size"]
    #[inline]
#[inline]     pub fn mps(&mut self) -> _MPSW {
        _MPSW { w: self }
    }
    #[doc = "Bit 15 - USB Active Endpoint"]
    #[inline]
#[inline]     pub fn usbactep(&mut self) -> _USBACTEPW {
        _USBACTEPW { w: self }
    }
    #[doc = "Bits 18:19 - Endpoint Type"]
    #[inline]
#[inline]     pub fn eptype(&mut self) -> _EPTYPEW {
        _EPTYPEW { w: self }
    }
    #[doc = "Bit 20 - Snoop Mode"]
    #[inline]
#[inline]     pub fn snp(&mut self) -> _SNPW {
        _SNPW { w: self }
    }
    #[doc = "Bit 21 - STALL Handshake"]
    #[inline]
#[inline]     pub fn stall(&mut self) -> _STALLW {
        _STALLW { w: self }
    }
    #[doc = "Bit 26 - Clear NAK"]
    #[inline]
#[inline]     pub fn cnak(&mut self) -> _CNAKW {
        _CNAKW { w: self }
    }
    #[doc = "Bit 27 - Set NAK"]
    #[inline]
#[inline]     pub fn snak(&mut self) -> _SNAKW {
        _SNAKW { w: self }
    }
    #[doc = "Bit 28 - Set DATA0 PID / Even Frame"]
    #[inline]
#[inline]     pub fn setd0pidef(&mut self) -> _SETD0PIDEFW {
        _SETD0PIDEFW { w: self }
    }
    #[doc = "Bit 29 - Set DATA1 PID / Odd Frame"]
    #[inline]
#[inline]     pub fn setd1pidof(&mut self) -> _SETD1PIDOFW {
        _SETD1PIDOFW { w: self }
    }
    #[doc = "Bit 30 - Endpoint Disable"]
    #[inline]
#[inline]     pub fn epdis(&mut self) -> _EPDISW {
        _EPDISW { w: self }
    }
    #[doc = "Bit 31 - Endpoint Enable"]
    #[inline]
#[inline]     pub fn epena(&mut self) -> _EPENAW {
        _EPENAW { w: self }
    }
}
