...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bit 0 - Advanced Encryption Standard Accelerator Clock Enable"]
    #[inline]
#[inline]     pub fn aes(&mut self) -> _AESW {
        _AESW { w: self }
    }
    #[doc = "Bit 1 - Direct Memory Access Controller Clock Enable"]
    #[inline]
#[inline]     pub fn dma(&mut self) -> _DMAW {
        _DMAW { w: self }
    }
    #[doc = "Bit 2 - Low Energy Peripheral Interface Clock Enable"]
    #[inline]
#[inline]     pub fn le(&mut self) -> _LEW {
        _LEW { w: self }
    }
    #[doc = "Bit 3 - Universal Serial Bus Interface Core Clock Enable"]
    #[inline]
#[inline]     pub fn usbc(&mut self) -> _USBCW {
        _USBCW { w: self }
    }
    #[doc = "Bit 4 - Universal Serial Bus Interface Clock Enable"]
    #[inline]
#[inline]     pub fn usb(&mut self) -> _USBW {
        _USBW { w: self }
    }
}
