...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> DTPRESCR {
        match value {
            0 => DTPRESCR::DIV1,
            1 => DTPRESCR::DIV2,
            2 => DTPRESCR::DIV4,
...
impl<'a> _DTPRESCW<'a> {
    ...
    #[inline]
#[inline]     pub fn variant(self, variant: DTPRESCW) -> &'a mut W {
...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn dtpresc(&self) -> DTPRESCR {
        DTPRESCR::_from({
            const MASK: u8 = 15;
            const OFFSET: u8 = 0;
    ...
    #[inline]
#[inline]     pub fn dtriset(&self) -> DTRISETR {
        let bits = {
            const MASK: u8 = 63;
            const OFFSET: u8 = 8;
            ((self.bits >> OFFSET) & MASK as u32) as u8
    ...
    #[inline]
#[inline]     pub fn dtfallt(&self) -> DTFALLTR {
        let bits = {
            const MASK: u8 = 63;
            const OFFSET: u8 = 16;
            ((self.bits >> OFFSET) & MASK as u32) as u8
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bits 0:3 - DTI Prescaler Setting"]
    #[inline]
#[inline]     pub fn dtpresc(&mut self) -> _DTPRESCW {
        _DTPRESCW { w: self }
    }
    #[doc = "Bits 8:13 - DTI Rise-time"]
    #[inline]
#[inline]     pub fn dtriset(&mut self) -> _DTRISETW {
        _DTRISETW { w: self }
    }
    #[doc = "Bits 16:21 - DTI Fall-time"]
    #[inline]
#[inline]     pub fn dtfallt(&mut self) -> _DTFALLTW {
        _DTFALLTW { w: self }
    }
}
