...
#[doc = r" Proxy"]
pub struct _IRQLATENCYW<'a> {
    w: &'a mut W,
}
impl<'a> _IRQLATENCYW<'a> {
...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn irqlatency(&self) -> IRQLATENCYR {
        let bits = {
            const MASK: u8 = 255;
            const OFFSET: u8 = 0;
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bits 0:7 - Irq Latency Register"]
    #[inline]
#[inline]     pub fn irqlatency(&mut self) -> _IRQLATENCYW {
        _IRQLATENCYW { w: self }
    }
}
