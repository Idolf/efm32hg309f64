...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> HFCORECLKDIVR {
        match value {
...
impl<'a> _HFCORECLKDIVW<'a> {
    ...
    #[inline]
#[inline]     pub fn variant(self, variant: HFCORECLKDIVW) -> &'a mut W {
...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn hfcoreclkdiv(&self) -> HFCORECLKDIVR {
        HFCORECLKDIVR::_from({
            const MASK: u8 = 15;
            const OFFSET: u8 = 0;
    ...
    #[inline]
#[inline]     pub fn hfcoreclklediv(&self) -> HFCORECLKLEDIVR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 8;
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bits 0:3 - HFCORECLK Divider"]
    #[inline]
#[inline]     pub fn hfcoreclkdiv(&mut self) -> _HFCORECLKDIVW {
        _HFCORECLKDIVW { w: self }
    }
    #[doc = "Bit 8 - Additional Division Factor For HFCORECLKLE"]
    #[inline]
#[inline]     pub fn hfcoreclklediv(&mut self) -> _HFCORECLKLEDIVW {
