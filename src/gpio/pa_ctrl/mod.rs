...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> DRIVEMODER {
        match value {
...
#[inline]     pub fn is_standard(&self) -> bool {
    ...
    #[inline]
#[inline]     pub fn is_lowest(&self) -> bool {
        *self == DRIVEMODER::LOWEST
    }
    #[doc = "Checks if the value of the field is `HIGH`"]
    #[inline]
#[inline]     pub fn is_high(&self) -> bool {
        *self == DRIVEMODER::HIGH
    }
    #[doc = "Checks if the value of the field is `LOW`"]
    #[inline]
#[inline]     pub fn is_low(&self) -> bool {
        *self == DRIVEMODER::LOW
    }
}
...
impl<'a> _DRIVEMODEW<'a> {
    ...
    #[inline]
#[inline]     pub fn variant(self, variant: DRIVEMODEW) -> &'a mut W {
        {
...
#[inline]     pub fn standard(self) -> &'a mut W {
    ...
    #[doc = "0.1 mA drive current"]
    #[inline]
#[inline]     pub fn lowest(self) -> &'a mut W {
        self.variant(DRIVEMODEW::LOWEST)
    }
    #[doc = "20 mA drive current"]
    #[inline]
#[inline]     pub fn high(self) -> &'a mut W {
        self.variant(DRIVEMODEW::HIGH)
    }
    #[doc = "1 mA drive current"]
    #[inline]
#[inline]     pub fn low(self) -> &'a mut W {
...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn drivemode(&self) -> DRIVEMODER {
        DRIVEMODER::_from({
            const MASK: u8 = 3;
            const OFFSET: u8 = 0;
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bits 0:1 - Drive Mode Select"]
    #[inline]
#[inline]     pub fn drivemode(&mut self) -> _DRIVEMODEW {
        _DRIVEMODEW { w: self }
    }
}
