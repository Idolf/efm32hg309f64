...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> OVSR {
        match value {
            0 => OVSR::X16,
            1 => OVSR::X8,
            2 => OVSR::X6,
...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> TXDELAYR {
        match value {
            0 => TXDELAYR::NONE,
            1 => TXDELAYR::SINGLE,
            2 => TXDELAYR::DOUBLE,
...
#[inline]     pub fn is_double(&self) -> bool {
    ...
    #[inline]
#[inline]     pub fn is_triple(&self) -> bool {
...
impl<'a> _OVSW<'a> {
    ...
    #[inline]
#[inline]     pub fn variant(self, variant: OVSW) -> &'a mut W {
        {
...
impl<'a> _TXDELAYW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
#[inline]     pub fn variant(self, variant: TXDELAYW) -> &'a mut W {
        {
            self.bits(variant._bits())
        }
    }
...
#[inline]     pub fn single(self) -> &'a mut W {
    ...
    #[doc = "Transmission of new frames are delayed by two baud periods"]
    #[inline]
#[inline]     pub fn double(self) -> &'a mut W {
        self.variant(TXDELAYW::DOUBLE)
    }
    #[doc = "Transmission of new frames are delayed by three baud periods"]
    #[inline]
#[inline]     pub fn triple(self) -> &'a mut W {
...
#[inline]     pub fn sync(&self) -> SYNCR {
    ...
    #[inline]
#[inline]     pub fn loopbk(&self) -> LOOPBKR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 1;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub fn ovs(&self) -> OVSR {
    ...
    #[inline]
#[inline]     pub fn clkpol(&self) -> CLKPOLR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 8;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn clkpha(&self) -> CLKPHAR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 9;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub fn csma(&self) -> CSMAR {
    ...
    #[inline]
#[inline]     pub fn txbil(&self) -> TXBILR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 12;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn rxinv(&self) -> RXINVR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 13;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn txinv(&self) -> TXINVR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 14;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn csinv(&self) -> CSINVR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 15;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn autocs(&self) -> AUTOCSR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 16;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn autotri(&self) -> AUTOTRIR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 17;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn scmode(&self) -> SCMODER {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 18;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn scretrans(&self) -> SCRETRANSR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 19;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn skipperrf(&self) -> SKIPPERRFR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 20;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn bit8dv(&self) -> BIT8DVR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 21;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn errsdma(&self) -> ERRSDMAR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 22;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn errsrx(&self) -> ERRSRXR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 23;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn errstx(&self) -> ERRSTXR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 24;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn sssearly(&self) -> SSSEARLYR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 25;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn txdelay(&self) -> TXDELAYR {
        TXDELAYR::_from({
            const MASK: u8 = 3;
            const OFFSET: u8 = 26;
            ((self.bits >> OFFSET) & MASK as u32) as u8
    ...
    #[inline]
#[inline]     pub fn byteswap(&self) -> BYTESWAPR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 28;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn autotx(&self) -> AUTOTXR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 29;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn mvdis(&self) -> MVDISR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 30;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn smsdelay(&self) -> SMSDELAYR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 31;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bit 0 - USART Synchronous Mode"]
    #[inline]
#[inline]     pub fn sync(&mut self) -> _SYNCW {
        _SYNCW { w: self }
    }
    #[doc = "Bit 1 - Loopback Enable"]
    #[inline]
#[inline]     pub fn loopbk(&mut self) -> _LOOPBKW {
        _LOOPBKW { w: self }
    }
    #[doc = "Bit 2 - Collision Check Enable"]
    #[inline]
#[inline]     pub fn ccen(&mut self) -> _CCENW {
        _CCENW { w: self }
    }
    #[doc = "Bit 3 - Multi-Processor Mode"]
    #[inline]
#[inline]     pub fn mpm(&mut self) -> _MPMW {
        _MPMW { w: self }
    }
    #[doc = "Bit 4 - Multi-Processor Address-Bit"]
    #[inline]
#[inline]     pub fn mpab(&mut self) -> _MPABW {
        _MPABW { w: self }
    }
    #[doc = "Bits 5:6 - Oversampling"]
    #[inline]
#[inline]     pub fn ovs(&mut self) -> _OVSW {
        _OVSW { w: self }
    }
    #[doc = "Bit 8 - Clock Polarity"]
    #[inline]
#[inline]     pub fn clkpol(&mut self) -> _CLKPOLW {
        _CLKPOLW { w: self }
    }
    #[doc = "Bit 9 - Clock Edge For Setup/Sample"]
    #[inline]
#[inline]     pub fn clkpha(&mut self) -> _CLKPHAW {
        _CLKPHAW { w: self }
    }
    #[doc = "Bit 10 - Most Significant Bit First"]
    #[inline]
#[inline]     pub fn msbf(&mut self) -> _MSBFW {
        _MSBFW { w: self }
    }
    #[doc = "Bit 11 - Action On Slave-Select In Master Mode"]
    #[inline]
#[inline]     pub fn csma(&mut self) -> _CSMAW {
        _CSMAW { w: self }
    }
    #[doc = "Bit 12 - TX Buffer Interrupt Level"]
    #[inline]
#[inline]     pub fn txbil(&mut self) -> _TXBILW {
        _TXBILW { w: self }
    }
    #[doc = "Bit 13 - Receiver Input Invert"]
    #[inline]
#[inline]     pub fn rxinv(&mut self) -> _RXINVW {
        _RXINVW { w: self }
    }
    #[doc = "Bit 14 - Transmitter output Invert"]
    #[inline]
#[inline]     pub fn txinv(&mut self) -> _TXINVW {
        _TXINVW { w: self }
    }
    #[doc = "Bit 15 - Chip Select Invert"]
    #[inline]
#[inline]     pub fn csinv(&mut self) -> _CSINVW {
        _CSINVW { w: self }
    }
    #[doc = "Bit 16 - Automatic Chip Select"]
    #[inline]
#[inline]     pub fn autocs(&mut self) -> _AUTOCSW {
        _AUTOCSW { w: self }
    }
    #[doc = "Bit 17 - Automatic TX Tristate"]
    #[inline]
#[inline]     pub fn autotri(&mut self) -> _AUTOTRIW {
        _AUTOTRIW { w: self }
    }
    #[doc = "Bit 18 - SmartCard Mode"]
    #[inline]
#[inline]     pub fn scmode(&mut self) -> _SCMODEW {
        _SCMODEW { w: self }
    }
    #[doc = "Bit 19 - SmartCard Retransmit"]
    #[inline]
#[inline]     pub fn scretrans(&mut self) -> _SCRETRANSW {
        _SCRETRANSW { w: self }
    }
    #[doc = "Bit 20 - Skip Parity Error Frames"]
    #[inline]
#[inline]     pub fn skipperrf(&mut self) -> _SKIPPERRFW {
        _SKIPPERRFW { w: self }
    }
    #[doc = "Bit 21 - Bit 8 Default Value"]
    #[inline]
#[inline]     pub fn bit8dv(&mut self) -> _BIT8DVW {
        _BIT8DVW { w: self }
    }
    #[doc = "Bit 22 - Halt DMA On Error"]
    #[inline]
#[inline]     pub fn errsdma(&mut self) -> _ERRSDMAW {
        _ERRSDMAW { w: self }
    }
    #[doc = "Bit 23 - Disable RX On Error"]
    #[inline]
#[inline]     pub fn errsrx(&mut self) -> _ERRSRXW {
        _ERRSRXW { w: self }
    }
    #[doc = "Bit 24 - Disable TX On Error"]
    #[inline]
#[inline]     pub fn errstx(&mut self) -> _ERRSTXW {
        _ERRSTXW { w: self }
    }
    #[doc = "Bit 25 - Synchronous Slave Setup Early"]
    #[inline]
#[inline]     pub fn sssearly(&mut self) -> _SSSEARLYW {
        _SSSEARLYW { w: self }
    }
    #[doc = "Bits 26:27 - TX Delay Transmission"]
    #[inline]
#[inline]     pub fn txdelay(&mut self) -> _TXDELAYW {
        _TXDELAYW { w: self }
    }
    #[doc = "Bit 28 - Byteswap In Double Accesses"]
    #[inline]
#[inline]     pub fn byteswap(&mut self) -> _BYTESWAPW {
        _BYTESWAPW { w: self }
    }
    #[doc = "Bit 29 - Always Transmit When RX Not Full"]
    #[inline]
#[inline]     pub fn autotx(&mut self) -> _AUTOTXW {
        _AUTOTXW { w: self }
    }
    #[doc = "Bit 30 - Majority Vote Disable"]
    #[inline]
#[inline]     pub fn mvdis(&mut self) -> _MVDISW {
        _MVDISW { w: self }
    }
    #[doc = "Bit 31 - Synchronous Master Sample Delay"]
    #[inline]
#[inline]     pub fn smsdelay(&mut self) -> _SMSDELAYW {
        _SMSDELAYW { w: self }
    }
}
