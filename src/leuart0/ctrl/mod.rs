...
#[inline]     pub fn loopbk(&self) -> LOOPBKR {
    ...
    #[inline]
#[inline]     pub fn sfubrx(&self) -> SFUBRXR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 8;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub fn bit8dv(&self) -> BIT8DVR {
    ...
    #[inline]
#[inline]     pub fn rxdmawu(&self) -> RXDMAWUR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 12;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn txdmawu(&self) -> TXDMAWUR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 13;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub fn stopbits(&mut self) -> _STOPBITSW {
    ...
    #[doc = "Bit 5 - Invert Input And Output"]
    #[inline]
#[inline]     pub fn inv(&mut self) -> _INVW {
        _INVW { w: self }
    }
    #[doc = "Bit 6 - Clear RX DMA On Error"]
    #[inline]
...
#[inline]     pub fn loopbk(&mut self) -> _LOOPBKW {
    ...
    #[doc = "Bit 8 - Start-Frame UnBlock RX"]
    #[inline]
#[inline]     pub fn sfubrx(&mut self) -> _SFUBRXW {
        _SFUBRXW { w: self }
    }
    #[doc = "Bit 9 - Multi-Processor Mode"]
    #[inline]
...
#[inline]     pub fn bit8dv(&mut self) -> _BIT8DVW {
    ...
    #[doc = "Bit 12 - RX DMA Wakeup"]
    #[inline]
#[inline]     pub fn rxdmawu(&mut self) -> _RXDMAWUW {
        _RXDMAWUW { w: self }
    }
    #[doc = "Bit 13 - TX DMA Wakeup"]
    #[inline]
#[inline]     pub fn txdmawu(&mut self) -> _TXDMAWUW {
        _TXDMAWUW { w: self }
    }
    #[doc = "Bits 14:15 - TX Delay Transmission"]
    #[inline]
