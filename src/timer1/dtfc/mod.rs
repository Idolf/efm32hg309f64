...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> DTPRS0FSELR {
        match value {
...
#[inline]     pub fn is_prsch5(&self) -> bool {
    ...
    #[inline]
#[inline]     pub fn is_prsch6(&self) -> bool {
        *self == DTPRS0FSELR::PRSCH6
    }
    #[doc = "Checks if the value of the field is `PRSCH7`"]
    #[inline]
#[inline]     pub fn is_prsch7(&self) -> bool {
...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> DTPRS1FSELR {
        match value {
...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> DTFAR {
        match value {
            0 => DTFAR::NONE,
            1 => DTFAR::INACTIVE,
            2 => DTFAR::CLEAR,
...
#[inline]     pub fn is_none(&self) -> bool {
    ...
    #[inline]
#[inline]     pub fn is_inactive(&self) -> bool {
        *self == DTFAR::INACTIVE
    }
...
#[inline]     pub fn is_clear(&self) -> bool {
    ...
    #[inline]
#[inline]     pub fn is_tristate(&self) -> bool {
        *self == DTFAR::TRISTATE
    }
}
...
impl<'a> _DTPRS0FSELW<'a> {
    ...
    #[inline]
#[inline]     pub fn variant(self, variant: DTPRS0FSELW) -> &'a mut W {
        {
...
#[inline]     pub fn prsch5(self) -> &'a mut W {
    ...
    #[doc = "PRS Channel 6 selected as fault source 0"]
    #[inline]
#[inline]     pub fn prsch6(self) -> &'a mut W {
        self.variant(DTPRS0FSELW::PRSCH6)
    }
    #[doc = "PRS Channel 7 selected as fault source 0"]
    #[inline]
#[inline]     pub fn prsch7(self) -> &'a mut W {
...
impl<'a> _DTPRS1FSELW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
#[inline]     pub fn variant(self, variant: DTPRS1FSELW) -> &'a mut W {
        {
            self.bits(variant._bits())
        }
    }
...
impl<'a> _DTFAW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
#[inline]     pub fn variant(self, variant: DTFAW) -> &'a mut W {
        {
            self.bits(variant._bits())
        }
    }
...
#[inline]     pub fn none(self) -> &'a mut W {
    ...
    #[doc = "Set outputs inactive"]
    #[inline]
#[inline]     pub fn inactive(self) -> &'a mut W {
...
#[inline]     pub fn clear(self) -> &'a mut W {
    ...
    #[doc = "Tristate outputs"]
    #[inline]
#[inline]     pub fn tristate(self) -> &'a mut W {
...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn dtprs0fsel(&self) -> DTPRS0FSELR {
        DTPRS0FSELR::_from({
            const MASK: u8 = 7;
            const OFFSET: u8 = 0;
    ...
    #[inline]
#[inline]     pub fn dtprs1fsel(&self) -> DTPRS1FSELR {
        DTPRS1FSELR::_from({
            const MASK: u8 = 7;
            const OFFSET: u8 = 8;
            ((self.bits >> OFFSET) & MASK as u32) as u8
...
#[inline]     pub fn dtfa(&self) -> DTFAR {
    ...
    #[inline]
#[inline]     pub fn dtprs0fen(&self) -> DTPRS0FENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 24;
    ...
    #[inline]
#[inline]     pub fn dtprs1fen(&self) -> DTPRS1FENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 25;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn dtdbgfen(&self) -> DTDBGFENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 26;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn dtlockupfen(&self) -> DTLOCKUPFENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 27;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bits 0:2 - DTI PRS Fault Source 0 Select"]
    #[inline]
#[inline]     pub fn dtprs0fsel(&mut self) -> _DTPRS0FSELW {
        _DTPRS0FSELW { w: self }
    }
    #[doc = "Bits 8:10 - DTI PRS Fault Source 1 Select"]
    #[inline]
#[inline]     pub fn dtprs1fsel(&mut self) -> _DTPRS1FSELW {
        _DTPRS1FSELW { w: self }
    }
    #[doc = "Bits 16:17 - DTI Fault Action"]
    #[inline]
#[inline]     pub fn dtfa(&mut self) -> _DTFAW {
        _DTFAW { w: self }
    }
    #[doc = "Bit 24 - DTI PRS 0 Fault Enable"]
    #[inline]
#[inline]     pub fn dtprs0fen(&mut self) -> _DTPRS0FENW {
        _DTPRS0FENW { w: self }
    }
    #[doc = "Bit 25 - DTI PRS 1 Fault Enable"]
    #[inline]
#[inline]     pub fn dtprs1fen(&mut self) -> _DTPRS1FENW {
        _DTPRS1FENW { w: self }
    }
    #[doc = "Bit 26 - DTI Debugger Fault Enable"]
    #[inline]
#[inline]     pub fn dtdbgfen(&mut self) -> _DTDBGFENW {
        _DTDBGFENW { w: self }
    }
    #[doc = "Bit 27 - DTI Lockup Fault Enable"]
    #[inline]
#[inline]     pub fn dtlockupfen(&mut self) -> _DTLOCKUPFENW {
