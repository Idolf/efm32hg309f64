...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> TSTARTR {
        match value {
            0 => TSTARTR::PRSCH0,
            1 => TSTARTR::PRSCH1,
            2 => TSTARTR::PRSCH2,
...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> TSTOPR {
        match value {
            0 => TSTOPR::PRSCH0,
            1 => TSTOPR::PRSCH1,
            2 => TSTOPR::PRSCH2,
...
impl<'a> _TSTARTW<'a> {
    ...
    #[inline]
#[inline]     pub fn variant(self, variant: TSTARTW) -> &'a mut W {
...
impl<'a> _TSTOPW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
#[inline]     pub fn variant(self, variant: TSTOPW) -> &'a mut W {
        unsafe { self.bits(variant._bits()) }
    }
    #[doc = "PRS ch 0 is controlling TSTOP."]
    #[inline]
...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn tstarten(&self) -> TSTARTENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 0;
    ...
    #[inline]
#[inline]     pub fn tstart(&self) -> TSTARTR {
        TSTARTR::_from({
            const MASK: u8 = 7;
            const OFFSET: u8 = 1;
    ...
    #[inline]
#[inline]     pub fn tstopen(&self) -> TSTOPENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 8;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn tstop(&self) -> TSTOPR {
        TSTOPR::_from({
            const MASK: u8 = 7;
            const OFFSET: u8 = 9;
            ((self.bits >> OFFSET) & MASK as u32) as u8
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bit 0 - PRS TSTART Enable"]
    #[inline]
#[inline]     pub fn tstarten(&mut self) -> _TSTARTENW {
        _TSTARTENW { w: self }
    }
    #[doc = "Bits 1:3 - MTB TSTART PRS select"]
    #[inline]
#[inline]     pub fn tstart(&mut self) -> _TSTARTW {
        _TSTARTW { w: self }
    }
    #[doc = "Bit 8 - PRS TSTOP Enable"]
    #[inline]
#[inline]     pub fn tstopen(&mut self) -> _TSTOPENW {
        _TSTOPENW { w: self }
    }
    #[doc = "Bits 9:11 - MTB TSTOP PRS select"]
    #[inline]
#[inline]     pub fn tstop(&mut self) -> _TSTOPW {
        _TSTOPW { w: self }
    }
}
