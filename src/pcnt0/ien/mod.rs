...
#[inline]     pub fn of(&self) -> OFR {
    ...
    #[inline]
#[inline]     pub fn dircng(&self) -> DIRCNGR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 2;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn auxof(&self) -> AUXOFR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 3;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub fn of(&mut self) -> _OFW {
    ...
    #[doc = "Bit 2 - Direction Change Detect Interrupt Enable"]
    #[inline]
#[inline]     pub fn dircng(&mut self) -> _DIRCNGW {
        _DIRCNGW { w: self }
    }
    #[doc = "Bit 3 - Auxiliary Overflow Interrupt Enable"]
    #[inline]
#[inline]     pub fn auxof(&mut self) -> _AUXOFW {
        _AUXOFW { w: self }
    }
    #[doc = "Bit 4 - Triggered compare Interrupt Enable"]
    #[inline]
#[inline]     pub fn tcc(&mut self) -> _TCCW {
        _TCCW { w: self }
    }
}
