...
#[inline]     pub fn bits(&self) -> u8 {
        match *self {
            HFXOMODER::XTAL => 0,
            HFXOMODER::BUFEXTCLK => 1,
            HFXOMODER::DIGEXTCLK => 2,
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> HFXOMODER {
        match value {
            0 => HFXOMODER::XTAL,
...
#[inline]     pub fn bits(&self) -> u8 {
        match *self {
            ...
            HFXOBOOSTR::_70PCENT => 1,
            HFXOBOOSTR::_80PCENT => 2,
            HFXOBOOSTR::_100PCENT => 3,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> HFXOBOOSTR {
        match value {
...
#[inline]     pub fn bits(&self) -> u8 {
        match *self {
            ...
            HFXOTIMEOUTR::_256CYCLES => 1,
            HFXOTIMEOUTR::_1KCYCLES => 2,
            HFXOTIMEOUTR::_16KCYCLES => 3,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> HFXOTIMEOUTR {
        match value {
...
#[inline]     pub fn bits(&self) -> u8 {
        match *self {
            LFXOMODER::XTAL => 0,
            LFXOMODER::BUFEXTCLK => 1,
            LFXOMODER::DIGEXTCLK => 2,
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> LFXOMODER {
        match value {
            0 => LFXOMODER::XTAL,
...
#[inline]     pub fn bits(&self) -> u8 {
        match *self {
            ...
            LFXOTIMEOUTR::_1KCYCLES => 1,
            LFXOTIMEOUTR::_16KCYCLES => 2,
            LFXOTIMEOUTR::_32KCYCLES => 3,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> LFXOTIMEOUTR {
        match value {
...
#[inline]     pub fn is_16kcycles(&self) -> bool {
    ...
    #[inline]
#[inline]     pub fn is_32kcycles(&self) -> bool {
...
#[inline]     pub fn bits(&self) -> u8 {
        match *self {
            CLKOUTSEL0R::HFRCO => 0,
            CLKOUTSEL0R::HFXO => 1,
            CLKOUTSEL0R::HFCLK2 => 2,
            CLKOUTSEL0R::HFCLK4 => 3,
            CLKOUTSEL0R::HFCLK8 => 4,
            CLKOUTSEL0R::HFCLK16 => 5,
            CLKOUTSEL0R::ULFRCO => 6,
            CLKOUTSEL0R::AUXHFRCO => 7,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> CLKOUTSEL0R {
        match value {
            0 => CLKOUTSEL0R::HFRCO,
            1 => CLKOUTSEL0R::HFXO,
...
#[inline]     pub fn bits(&self) -> u8 {
        match *self {
            ...
            CLKOUTSEL1R::LFXOQ => 3,
            CLKOUTSEL1R::HFXOQ => 4,
            CLKOUTSEL1R::LFRCOQ => 5,
            CLKOUTSEL1R::HFRCOQ => 6,
            CLKOUTSEL1R::AUXHFRCOQ => 7,
            CLKOUTSEL1R::USHFRCO => 8,
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> CLKOUTSEL1R {
        match value {
            0 => CLKOUTSEL1R::LFRCO,
            1 => CLKOUTSEL1R::LFXO,
            2 => CLKOUTSEL1R::HFCLK,
...
impl<'a> _HFXOMODEW<'a> {
    ...
    #[inline]
#[inline]     pub fn variant(self, variant: HFXOMODEW) -> &'a mut W {
        unsafe { self.bits(variant._bits()) }
    }
    #[doc = "4-25 MHz crystal oscillator."]
    #[inline]
#[inline]     pub fn xtal(self) -> &'a mut W {
        self.variant(HFXOMODEW::XTAL)
    }
    #[doc = "An AC coupled buffer is coupled in series with HFXTAL_N, suitable for external sine wave (4-25 MHz). The sine wave should have a minimum of 200 mV peak to peak."]
    #[inline]
#[inline]     pub fn bufextclk(self) -> &'a mut W {
        self.variant(HFXOMODEW::BUFEXTCLK)
    }
    #[doc = "Digital external clock on HFXTAL_N pin. Oscillator is effectively bypassed."]
    #[inline]
#[inline]     pub fn digextclk(self) -> &'a mut W {
...
impl<'a> _HFXOBOOSTW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
#[inline]     pub fn variant(self, variant: HFXOBOOSTW) -> &'a mut W {
        {
    ...
    #[doc = "50 %."]
    #[inline]
#[inline]     pub fn _50pcent(self) -> &'a mut W {
        self.variant(HFXOBOOSTW::_50PCENT)
    }
    #[doc = "70 %."]
    #[inline]
#[inline]     pub fn _70pcent(self) -> &'a mut W {
        self.variant(HFXOBOOSTW::_70PCENT)
    }
    #[doc = "80 %."]
    #[inline]
#[inline]     pub fn _80pcent(self) -> &'a mut W {
        self.variant(HFXOBOOSTW::_80PCENT)
    }
    #[doc = "100 % (default)."]
    #[inline]
#[inline]     pub fn _100pcent(self) -> &'a mut W {
...
impl<'a> _HFXOTIMEOUTW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
#[inline]     pub fn variant(self, variant: HFXOTIMEOUTW) -> &'a mut W {
        {
            self.bits(variant._bits())
        }
    }
...
#[inline]     pub fn _256cycles(self) -> &'a mut W {
    ...
    #[doc = "Timeout period of 1024 cycles."]
    #[inline]
#[inline]     pub fn _1kcycles(self) -> &'a mut W {
        self.variant(HFXOTIMEOUTW::_1KCYCLES)
    }
    #[doc = "Timeout period of 16384 cycles."]
    #[inline]
#[inline]     pub fn _16kcycles(self) -> &'a mut W {
...
impl<'a> _LFXOMODEW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
#[inline]     pub fn variant(self, variant: LFXOMODEW) -> &'a mut W {
        unsafe { self.bits(variant._bits()) }
    }
    #[doc = "32.768 kHz crystal oscillator."]
    #[inline]
...
impl<'a> _LFXOTIMEOUTW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
#[inline]     pub fn variant(self, variant: LFXOTIMEOUTW) -> &'a mut W {
        {
            self.bits(variant._bits())
        }
    }
...
#[inline]     pub fn _16kcycles(self) -> &'a mut W {
    ...
    #[doc = "Timeout period of 32768 cycles."]
    #[inline]
#[inline]     pub fn _32kcycles(self) -> &'a mut W {
...
impl<'a> _CLKOUTSEL0W<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
#[inline]     pub fn variant(self, variant: CLKOUTSEL0W) -> &'a mut W {
        {
            self.bits(variant._bits())
        }
    }
...
#[inline]     pub fn hfxo(self) -> &'a mut W {
    ...
    #[doc = "HFCLK/2."]
    #[inline]
#[inline]     pub fn hfclk2(self) -> &'a mut W {
        self.variant(CLKOUTSEL0W::HFCLK2)
    }
    #[doc = "HFCLK/4."]
    #[inline]
#[inline]     pub fn hfclk4(self) -> &'a mut W {
        self.variant(CLKOUTSEL0W::HFCLK4)
    }
    #[doc = "HFCLK/8."]
    #[inline]
#[inline]     pub fn hfclk8(self) -> &'a mut W {
        self.variant(CLKOUTSEL0W::HFCLK8)
    }
    #[doc = "HFCLK/16."]
    #[inline]
#[inline]     pub fn hfclk16(self) -> &'a mut W {
        self.variant(CLKOUTSEL0W::HFCLK16)
    }
    #[doc = "ULFRCO (directly from oscillator)."]
    #[inline]
#[inline]     pub fn ulfrco(self) -> &'a mut W {
...
impl<'a> _CLKOUTSEL1W<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
#[inline]     pub fn variant(self, variant: CLKOUTSEL1W) -> &'a mut W {
        unsafe { self.bits(variant._bits()) }
    }
    #[doc = "LFRCO (directly from oscillator)."]
    #[inline]
...
#[inline]     pub fn hfclk(self) -> &'a mut W {
    ...
    #[doc = "LFXO (qualified)."]
    #[inline]
#[inline]     pub fn lfxoq(self) -> &'a mut W {
        self.variant(CLKOUTSEL1W::LFXOQ)
    }
    #[doc = "HFXO (qualified)."]
    #[inline]
#[inline]     pub fn hfxoq(self) -> &'a mut W {
        self.variant(CLKOUTSEL1W::HFXOQ)
    }
    #[doc = "LFRCO (qualified)."]
    #[inline]
#[inline]     pub fn lfrcoq(self) -> &'a mut W {
        self.variant(CLKOUTSEL1W::LFRCOQ)
    }
    #[doc = "HFRCO (qualified)."]
    #[inline]
#[inline]     pub fn hfrcoq(self) -> &'a mut W {
        self.variant(CLKOUTSEL1W::HFRCOQ)
    }
    #[doc = "AUXHFRCO (qualified)."]
    #[inline]
#[inline]     pub fn auxhfrcoq(self) -> &'a mut W {
        self.variant(CLKOUTSEL1W::AUXHFRCOQ)
    }
    #[doc = "USHFRCO"]
    #[inline]
#[inline]     pub fn ushfrco(self) -> &'a mut W {
        self.variant(CLKOUTSEL1W::USHFRCO)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
#[inline]     pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn hfxomode(&self) -> HFXOMODER {
        HFXOMODER::_from({
            const MASK: u8 = 3;
            const OFFSET: u8 = 0;
    ...
    #[inline]
#[inline]     pub fn hfxoboost(&self) -> HFXOBOOSTR {
        HFXOBOOSTR::_from({
            const MASK: u8 = 3;
            const OFFSET: u8 = 2;
            ((self.bits >> OFFSET) & MASK as u32) as u8
    ...
    #[inline]
#[inline]     pub fn hfxobufcur(&self) -> HFXOBUFCURR {
        let bits = {
            const MASK: u8 = 3;
            const OFFSET: u8 = 5;
            ((self.bits >> OFFSET) & MASK as u32) as u8
    ...
    #[inline]
#[inline]     pub fn hfxoglitchdeten(&self) -> HFXOGLITCHDETENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 7;
    ...
    #[inline]
#[inline]     pub fn hfxotimeout(&self) -> HFXOTIMEOUTR {
        HFXOTIMEOUTR::_from({
            const MASK: u8 = 3;
            const OFFSET: u8 = 9;
            ((self.bits >> OFFSET) & MASK as u32) as u8
    ...
    #[inline]
#[inline]     pub fn lfxomode(&self) -> LFXOMODER {
        LFXOMODER::_from({
            const MASK: u8 = 3;
            const OFFSET: u8 = 11;
            ((self.bits >> OFFSET) & MASK as u32) as u8
    ...
    #[inline]
#[inline]     pub fn lfxoboost(&self) -> LFXOBOOSTR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 13;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn hfclkdiv(&self) -> HFCLKDIVR {
        let bits = {
            const MASK: u8 = 7;
            const OFFSET: u8 = 14;
            ((self.bits >> OFFSET) & MASK as u32) as u8
    ...
    #[inline]
#[inline]     pub fn lfxobufcur(&self) -> LFXOBUFCURR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 17;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn lfxotimeout(&self) -> LFXOTIMEOUTR {
        LFXOTIMEOUTR::_from({
            const MASK: u8 = 3;
            const OFFSET: u8 = 18;
            ((self.bits >> OFFSET) & MASK as u32) as u8
    ...
    #[inline]
#[inline]     pub fn clkoutsel0(&self) -> CLKOUTSEL0R {
        CLKOUTSEL0R::_from({
            const MASK: u8 = 7;
            const OFFSET: u8 = 20;
            ((self.bits >> OFFSET) & MASK as u32) as u8
    ...
    #[inline]
#[inline]     pub fn clkoutsel1(&self) -> CLKOUTSEL1R {
        CLKOUTSEL1R::_from({
            const MASK: u8 = 15;
            const OFFSET: u8 = 23;
            ((self.bits >> OFFSET) & MASK as u32) as u8
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bits 0:1 - HFXO Mode"]
    #[inline]
#[inline]     pub fn hfxomode(&mut self) -> _HFXOMODEW {
        _HFXOMODEW { w: self }
    }
    #[doc = "Bits 2:3 - HFXO Start-up Boost Current"]
    #[inline]
#[inline]     pub fn hfxoboost(&mut self) -> _HFXOBOOSTW {
        _HFXOBOOSTW { w: self }
    }
    #[doc = "Bits 5:6 - HFXO Boost Buffer Current"]
    #[inline]
#[inline]     pub fn hfxobufcur(&mut self) -> _HFXOBUFCURW {
        _HFXOBUFCURW { w: self }
    }
    #[doc = "Bit 7 - HFXO Glitch Detector Enable"]
    #[inline]
#[inline]     pub fn hfxoglitchdeten(&mut self) -> _HFXOGLITCHDETENW {
        _HFXOGLITCHDETENW { w: self }
    }
    #[doc = "Bits 9:10 - HFXO Timeout"]
    #[inline]
#[inline]     pub fn hfxotimeout(&mut self) -> _HFXOTIMEOUTW {
        _HFXOTIMEOUTW { w: self }
    }
    #[doc = "Bits 11:12 - LFXO Mode"]
    #[inline]
#[inline]     pub fn lfxomode(&mut self) -> _LFXOMODEW {
        _LFXOMODEW { w: self }
    }
    #[doc = "Bit 13 - LFXO Start-up Boost Current"]
    #[inline]
#[inline]     pub fn lfxoboost(&mut self) -> _LFXOBOOSTW {
        _LFXOBOOSTW { w: self }
    }
    #[doc = "Bits 14:16 - HFCLK Division"]
    #[inline]
#[inline]     pub fn hfclkdiv(&mut self) -> _HFCLKDIVW {
        _HFCLKDIVW { w: self }
    }
    #[doc = "Bit 17 - LFXO Boost Buffer Current"]
    #[inline]
#[inline]     pub fn lfxobufcur(&mut self) -> _LFXOBUFCURW {
        _LFXOBUFCURW { w: self }
    }
    #[doc = "Bits 18:19 - LFXO Timeout"]
    #[inline]
#[inline]     pub fn lfxotimeout(&mut self) -> _LFXOTIMEOUTW {
        _LFXOTIMEOUTW { w: self }
    }
    #[doc = "Bits 20:22 - Clock Output Select 0"]
    #[inline]
#[inline]     pub fn clkoutsel0(&mut self) -> _CLKOUTSEL0W {
        _CLKOUTSEL0W { w: self }
    }
    #[doc = "Bits 23:26 - Clock Output Select 1"]
    #[inline]
#[inline]     pub fn clkoutsel1(&mut self) -> _CLKOUTSEL1W {
        _CLKOUTSEL1W { w: self }
    }
}
