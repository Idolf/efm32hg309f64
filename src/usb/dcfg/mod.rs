...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> DEVSPDR {
        match value {
            2 => DEVSPDR::LS,
            3 => DEVSPDR::FS,
...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> PERFRINTR {
        match value {
            0 => PERFRINTR::_80PCNT,
            1 => PERFRINTR::_85PCNT,
            2 => PERFRINTR::_90PCNT,
...
impl<'a> _DEVSPDW<'a> {
    ...
    #[inline]
#[inline]     pub fn variant(self, variant: DEVSPDW) -> &'a mut W {
        unsafe { self.bits(variant._bits()) }
    }
    #[doc = "Low speed (PHY clock is 6 MHz). If you select 6 MHz LS mode, you must do a soft reset."]
    #[inline]
#[inline]     pub fn ls(self) -> &'a mut W {
        self.variant(DEVSPDW::LS)
    }
    #[doc = "Full speed (PHY clock is 48 MHz)."]
    #[inline]
#[inline]     pub fn fs(self) -> &'a mut W {
...
impl<'a> _PERFRINTW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
#[inline]     pub fn variant(self, variant: PERFRINTW) -> &'a mut W {
        {
    ...
    #[doc = "80% of the frame interval."]
    #[inline]
#[inline]     pub fn _80pcnt(self) -> &'a mut W {
        self.variant(PERFRINTW::_80PCNT)
    }
    #[doc = "85% of the frame interval."]
    #[inline]
#[inline]     pub fn _85pcnt(self) -> &'a mut W {
        self.variant(PERFRINTW::_85PCNT)
    }
    #[doc = "90% of the frame interval."]
    #[inline]
#[inline]     pub fn _90pcnt(self) -> &'a mut W {
        self.variant(PERFRINTW::_90PCNT)
    }
    #[doc = "95% of the frame interval."]
    #[inline]
#[inline]     pub fn _95pcnt(self) -> &'a mut W {
...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn devspd(&self) -> DEVSPDR {
        DEVSPDR::_from({
            const MASK: u8 = 3;
            const OFFSET: u8 = 0;
    ...
    #[inline]
#[inline]     pub fn nzstsouthshk(&self) -> NZSTSOUTHSHKR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 2;
    ...
    #[inline]
#[inline]     pub fn ena32khzsusp(&self) -> ENA32KHZSUSPR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 3;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn devaddr(&self) -> DEVADDRR {
        let bits = {
            const MASK: u8 = 127;
            const OFFSET: u8 = 4;
            ((self.bits >> OFFSET) & MASK as u32) as u8
    ...
    #[inline]
#[inline]     pub fn perfrint(&self) -> PERFRINTR {
        PERFRINTR::_from({
            const MASK: u8 = 3;
            const OFFSET: u8 = 11;
            ((self.bits >> OFFSET) & MASK as u32) as u8
    ...
    #[doc = "Bit 15 - \"\""]
    #[inline]
#[inline]     pub fn erraticintmsk(&self) -> ERRATICINTMSKR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 15;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn resvalid(&self) -> RESVALIDR {
        let bits = {
            const MASK: u8 = 63;
            const OFFSET: u8 = 26;
            ((self.bits >> OFFSET) & MASK as u32) as u8
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bits 0:1 - Device Speed"]
    #[inline]
#[inline]     pub fn devspd(&mut self) -> _DEVSPDW {
        _DEVSPDW { w: self }
    }
    #[doc = "Bit 2 - Non-Zero-Length Status OUT Handshake"]
    #[inline]
#[inline]     pub fn nzstsouthshk(&mut self) -> _NZSTSOUTHSHKW {
        _NZSTSOUTHSHKW { w: self }
    }
    #[doc = "Bit 3 - Enable 32 KHz Suspend mode"]
    #[inline]
#[inline]     pub fn ena32khzsusp(&mut self) -> _ENA32KHZSUSPW {
        _ENA32KHZSUSPW { w: self }
    }
    #[doc = "Bits 4:10 - Device Address"]
    #[inline]
#[inline]     pub fn devaddr(&mut self) -> _DEVADDRW {
        _DEVADDRW { w: self }
    }
    #[doc = "Bits 11:12 - Periodic Frame Interval"]
    #[inline]
#[inline]     pub fn perfrint(&mut self) -> _PERFRINTW {
        _PERFRINTW { w: self }
    }
    #[doc = "Bit 15 - \"\""]
    #[inline]
#[inline]     pub fn erraticintmsk(&mut self) -> _ERRATICINTMSKW {
        _ERRATICINTMSKW { w: self }
    }
    #[doc = "Bits 26:31 - Resume Validation Period"]
    #[inline]
#[inline]     pub fn resvalid(&mut self) -> _RESVALIDW {
        _RESVALIDW { w: self }
    }
}
