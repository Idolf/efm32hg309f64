...
#[inline]     pub fn _from(value: u8) -> MODER {
    ...
    #[inline]
#[inline]     pub fn is_ws0(&self) -> bool {
        *self == MODER::WS0
    }
    #[doc = "Checks if the value of the field is `WS1`"]
    #[inline]
#[inline]     pub fn is_ws1(&self) -> bool {
        *self == MODER::WS1
    }
}
...
#[inline]     pub fn variant(self, variant: MODEW) -> &'a mut W {
    ...
    #[doc = "Zero wait-states inserted in fetch or read transfers."]
    #[inline]
#[inline]     pub fn ws0(self) -> &'a mut W {
        self.variant(MODEW::WS0)
    }
    #[doc = "One wait-state inserted for each fetch or read transfer. This mode is required for a core frequency above 16 MHz."]
    #[inline]
#[inline]     pub fn ws1(self) -> &'a mut W {
...
#[inline]     pub fn mode(&self) -> MODER {
    ...
    #[inline]
#[inline]     pub fn ifcdis(&self) -> IFCDISR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 3;
    ...
    #[inline]
#[inline]     pub fn aidis(&self) -> AIDISR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 4;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn ramcen(&self) -> RAMCENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 7;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub fn mode(&mut self) -> _MODEW {
    ...
    #[doc = "Bit 3 - Internal Flash Cache Disable"]
    #[inline]
#[inline]     pub fn ifcdis(&mut self) -> _IFCDISW {
        _IFCDISW { w: self }
    }
    #[doc = "Bit 4 - Automatic Invalidate Disable"]
    #[inline]
#[inline]     pub fn aidis(&mut self) -> _AIDISW {
        _AIDISW { w: self }
    }
    #[doc = "Bit 7 - RAM Cache Enable"]
    #[inline]
#[inline]     pub fn ramcen(&mut self) -> _RAMCENW {
        _RAMCENW { w: self }
    }
}
