...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn pulsew(&self) -> PULSEWR {
        let bits = {
            const MASK: u8 = 15;
            const OFFSET: u8 = 0;
    ...
    #[inline]
#[inline]     pub fn pulseen(&self) -> PULSEENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 4;
    ...
    #[inline]
#[inline]     pub fn pulsefilt(&self) -> PULSEFILTR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 5;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bits 0:3 - Pulse Width"]
    #[inline]
#[inline]     pub fn pulsew(&mut self) -> _PULSEWW {
        _PULSEWW { w: self }
    }
    #[doc = "Bit 4 - Pulse Generator/Extender Enable"]
    #[inline]
#[inline]     pub fn pulseen(&mut self) -> _PULSEENW {
        _PULSEENW { w: self }
    }
    #[doc = "Bit 5 - Pulse Filter"]
    #[inline]
#[inline]     pub fn pulsefilt(&mut self) -> _PULSEFILTW {
        _PULSEFILTW { w: self }
    }
}
