...
#[inline]     pub fn _from(value: u8) -> BANDR {
    ...
    #[inline]
#[inline]     pub fn is_48mhz(&self) -> bool {
        *self == BANDR::_48MHZ
    }
    #[doc = "Checks if the value of the field is `_24MHZ`"]
    #[inline]
#[inline]     pub fn is_24mhz(&self) -> bool {
        *self == BANDR::_24MHZ
    }
}
...
#[inline]     pub fn variant(self, variant: BANDW) -> &'a mut W {
    ...
    #[doc = "48 MHz band. NOTE: Also set the TUNING and FINETUNING value when changing band."]
    #[inline]
#[inline]     pub fn _48mhz(self) -> &'a mut W {
        self.variant(BANDW::_48MHZ)
    }
    #[doc = "24 MHz band. NOTE: Also set the TUNING and FINETUNING value when changing band."]
    #[inline]
#[inline]     pub fn _24mhz(self) -> &'a mut W {
...
#[inline]     pub fn band(&self) -> BANDR {
    ...
    #[inline]
#[inline]     pub fn ushfrcodiv2dis(&self) -> USHFRCODIV2DISR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 4;
...
#[inline]     pub fn band(&mut self) -> _BANDW {
    ...
    #[doc = "Bit 4 - USHFRCO divider for HFCLK disable"]
    #[inline]
#[inline]     pub fn ushfrcodiv2dis(&mut self) -> _USHFRCODIV2DISW {
