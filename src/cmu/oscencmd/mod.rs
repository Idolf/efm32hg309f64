...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[inline]
#[inline]     pub fn hfrcoen(&mut self) -> _HFRCOENW {
        _HFRCOENW { w: self }
    }
    #[doc = "Bit 1 - HFRCO Disable"]
    #[inline]
#[inline]     pub fn hfrcodis(&mut self) -> _HFRCODISW {
        _HFRCODISW { w: self }
    }
    #[doc = "Bit 2 - HFXO Enable"]
    #[inline]
#[inline]     pub fn hfxoen(&mut self) -> _HFXOENW {
        _HFXOENW { w: self }
    }
    #[doc = "Bit 3 - HFXO Disable"]
    #[inline]
#[inline]     pub fn hfxodis(&mut self) -> _HFXODISW {
        _HFXODISW { w: self }
    }
    #[doc = "Bit 4 - AUXHFRCO Enable"]
    #[inline]
#[inline]     pub fn auxhfrcoen(&mut self) -> _AUXHFRCOENW {
        _AUXHFRCOENW { w: self }
    }
    #[doc = "Bit 5 - AUXHFRCO Disable"]
    #[inline]
#[inline]     pub fn auxhfrcodis(&mut self) -> _AUXHFRCODISW {
        _AUXHFRCODISW { w: self }
    }
    #[doc = "Bit 6 - LFRCO Enable"]
    #[inline]
#[inline]     pub fn lfrcoen(&mut self) -> _LFRCOENW {
        _LFRCOENW { w: self }
    }
    #[doc = "Bit 7 - LFRCO Disable"]
    #[inline]
#[inline]     pub fn lfrcodis(&mut self) -> _LFRCODISW {
        _LFRCODISW { w: self }
    }
    #[doc = "Bit 8 - LFXO Enable"]
    #[inline]
#[inline]     pub fn lfxoen(&mut self) -> _LFXOENW {
        _LFXOENW { w: self }
    }
    #[doc = "Bit 9 - LFXO Disable"]
    #[inline]
#[inline]     pub fn lfxodis(&mut self) -> _LFXODISW {
        _LFXODISW { w: self }
    }
    #[doc = "Bit 10 - USHFRCO Enable"]
    #[inline]
#[inline]     pub fn ushfrcoen(&mut self) -> _USHFRCOENW {
        _USHFRCOENW { w: self }
    }
    #[doc = "Bit 11 - USHFRCO Disable"]
    #[inline]
#[inline]     pub fn ushfrcodis(&mut self) -> _USHFRCODISW {
        _USHFRCODISW { w: self }
    }
}
