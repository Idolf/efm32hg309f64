...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> CLHRR {
        match value {
            0 => CLHRR::STANDARD,
            1 => CLHRR::ASYMMETRIC,
            2 => CLHRR::FAST,
...
#[inline]     pub fn is_standard(&self) -> bool {
    ...
    #[inline]
#[inline]     pub fn is_asymmetric(&self) -> bool {
...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> BITOR {
        match value {
            0 => BITOR::OFF,
            1 => BITOR::_40PCC,
            2 => BITOR::_80PCC,
...
#[inline]     pub fn is_off(&self) -> bool {
    ...
    #[inline]
#[inline]     pub fn is_40pcc(&self) -> bool {
        *self == BITOR::_40PCC
    }
    #[doc = "Checks if the value of the field is `_80PCC`"]
    #[inline]
#[inline]     pub fn is_80pcc(&self) -> bool {
        *self == BITOR::_80PCC
    }
    #[doc = "Checks if the value of the field is `_160PCC`"]
    #[inline]
#[inline]     pub fn is_160pcc(&self) -> bool {
        *self == BITOR::_160PCC
    }
}
#[doc = r" Value of the field"]
...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> CLTOR {
        match value {
            0 => CLTOR::OFF,
            1 => CLTOR::_40PCC,
            2 => CLTOR::_80PCC,
...
#[inline]     pub fn is_160pcc(&self) -> bool {
    ...
    #[inline]
#[inline]     pub fn is_320ppc(&self) -> bool {
        *self == CLTOR::_320PPC
    }
    #[doc = "Checks if the value of the field is `_1024PPC`"]
    #[inline]
#[inline]     pub fn is_1024ppc(&self) -> bool {
        *self == CLTOR::_1024PPC
    }
}
#[doc = r" Proxy"]
...
impl<'a> _CLHRW<'a> {
    ...
    #[inline]
#[inline]     pub fn variant(self, variant: CLHRW) -> &'a mut W {
        unsafe { self.bits(variant._bits()) }
    }
    #[doc = "The ratio between low period and high period counters (Nlow:Nhigh) is 4:4"]
    #[inline]
#[inline]     pub fn standard(self) -> &'a mut W {
        self.variant(CLHRW::STANDARD)
    }
    #[doc = "The ratio between low period and high period counters (Nlow:Nhigh) is 6:3"]
    #[inline]
#[inline]     pub fn asymmetric(self) -> &'a mut W {
        self.variant(CLHRW::ASYMMETRIC)
    }
    #[doc = "The ratio between low period and high period counters (Nlow:Nhigh) is 11:6"]
    #[inline]
#[inline]     pub fn fast(self) -> &'a mut W {
...
impl<'a> _BITOW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
#[inline]     pub fn variant(self, variant: BITOW) -> &'a mut W {
        {
...
#[inline]     pub fn off(self) -> &'a mut W {
    ...
    #[doc = "Timeout after 40 prescaled clock cycles. In standard mode at 100 kHz, this results in a 50us timeout."]
    #[inline]
#[inline]     pub fn _40pcc(self) -> &'a mut W {
        self.variant(BITOW::_40PCC)
    }
    #[doc = "Timeout after 80 prescaled clock cycles. In standard mode at 100 kHz, this results in a 100us timeout."]
    #[inline]
#[inline]     pub fn _80pcc(self) -> &'a mut W {
        self.variant(BITOW::_80PCC)
    }
    #[doc = "Timeout after 160 prescaled clock cycles. In standard mode at 100 kHz, this results in a 200us timeout."]
    #[inline]
#[inline]     pub fn _160pcc(self) -> &'a mut W {
...
impl<'a> _CLTOW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
#[inline]     pub fn variant(self, variant: CLTOW) -> &'a mut W {
        unsafe { self.bits(variant._bits()) }
    }
    #[doc = "Timeout disabled"]
    #[inline]
...
#[inline]     pub fn _160pcc(self) -> &'a mut W {
    ...
    #[doc = "Timeout after 320 prescaled clock cycles. In standard mode at 100 kHz, this results in a 400us timeout."]
    #[inline]
#[inline]     pub fn _320ppc(self) -> &'a mut W {
        self.variant(CLTOW::_320PPC)
    }
    #[doc = "Timeout after 1024 prescaled clock cycles. In standard mode at 100 kHz, this results in a 1280us timeout."]
    #[inline]
#[inline]     pub fn _1024ppc(self) -> &'a mut W {
...
#[inline]     pub fn en(&self) -> ENR {
    ...
    #[inline]
#[inline]     pub fn slave(&self) -> SLAVER {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 1;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn autoack(&self) -> AUTOACKR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 2;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn autose(&self) -> AUTOSER {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 3;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn autosn(&self) -> AUTOSNR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 4;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn arbdis(&self) -> ARBDISR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 5;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn gcamen(&self) -> GCAMENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 6;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub fn bito(&self) -> BITOR {
    ...
    #[inline]
#[inline]     pub fn gibito(&self) -> GIBITOR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 15;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub fn en(&mut self) -> _ENW {
    ...
    #[doc = "Bit 1 - Addressable as Slave"]
    #[inline]
#[inline]     pub fn slave(&mut self) -> _SLAVEW {
        _SLAVEW { w: self }
    }
    #[doc = "Bit 2 - Automatic Acknowledge"]
    #[inline]
#[inline]     pub fn autoack(&mut self) -> _AUTOACKW {
        _AUTOACKW { w: self }
    }
    #[doc = "Bit 3 - Automatic STOP when Empty"]
    #[inline]
#[inline]     pub fn autose(&mut self) -> _AUTOSEW {
        _AUTOSEW { w: self }
    }
    #[doc = "Bit 4 - Automatic STOP on NACK"]
    #[inline]
#[inline]     pub fn autosn(&mut self) -> _AUTOSNW {
        _AUTOSNW { w: self }
    }
    #[doc = "Bit 5 - Arbitration Disable"]
    #[inline]
#[inline]     pub fn arbdis(&mut self) -> _ARBDISW {
        _ARBDISW { w: self }
    }
    #[doc = "Bit 6 - General Call Address Match Enable"]
    #[inline]
#[inline]     pub fn gcamen(&mut self) -> _GCAMENW {
        _GCAMENW { w: self }
    }
    #[doc = "Bits 8:9 - Clock Low High Ratio"]
    #[inline]
#[inline]     pub fn clhr(&mut self) -> _CLHRW {
        _CLHRW { w: self }
    }
    #[doc = "Bits 12:13 - Bus Idle Timeout"]
    #[inline]
#[inline]     pub fn bito(&mut self) -> _BITOW {
        _BITOW { w: self }
    }
    #[doc = "Bit 15 - Go Idle on Bus Idle Timeout"]
    #[inline]
#[inline]     pub fn gibito(&mut self) -> _GIBITOW {
        _GIBITOW { w: self }
    }
    #[doc = "Bits 16:18 - Clock Low Timeout"]
    #[inline]
#[inline]     pub fn clto(&mut self) -> _CLTOW {
        _CLTOW { w: self }
    }
}
