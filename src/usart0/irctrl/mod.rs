...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> IRPWR {
        match value {
            0 => IRPWR::ONE,
            1 => IRPWR::TWO,
            2 => IRPWR::THREE,
...
#[inline]     pub fn is_two(&self) -> bool {
    ...
    #[inline]
#[inline]     pub fn is_three(&self) -> bool {
        *self == IRPWR::THREE
    }
...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> IRPRSSELR {
        match value {
            0 => IRPRSSELR::PRSCH0,
            1 => IRPRSSELR::PRSCH1,
            2 => IRPRSSELR::PRSCH2,
...
impl<'a> _IRPWW<'a> {
    ...
    #[inline]
#[inline]     pub fn variant(self, variant: IRPWW) -> &'a mut W {
        {
...
#[inline]     pub fn two(self) -> &'a mut W {
    ...
    #[doc = "IrDA pulse width is 3/16 for OVS=0 and 3/8 for OVS=1"]
    #[inline]
#[inline]     pub fn three(self) -> &'a mut W {
...
impl<'a> _IRPRSSELW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
#[inline]     pub fn variant(self, variant: IRPRSSELW) -> &'a mut W {
...
#[inline]     pub fn irpw(&self) -> IRPWR {
    ...
    #[inline]
#[inline]     pub fn irfilt(&self) -> IRFILTR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 3;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn irprssel(&self) -> IRPRSSELR {
        IRPRSSELR::_from({
            const MASK: u8 = 7;
            const OFFSET: u8 = 4;
            ((self.bits >> OFFSET) & MASK as u32) as u8
    ...
    #[inline]
#[inline]     pub fn irprsen(&self) -> IRPRSENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 7;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bit 0 - Enable IrDA Module"]
    #[inline]
#[inline]     pub fn iren(&mut self) -> _IRENW {
        _IRENW { w: self }
    }
    #[doc = "Bits 1:2 - IrDA TX Pulse Width"]
    #[inline]
#[inline]     pub fn irpw(&mut self) -> _IRPWW {
        _IRPWW { w: self }
    }
    #[doc = "Bit 3 - IrDA RX Filter"]
    #[inline]
#[inline]     pub fn irfilt(&mut self) -> _IRFILTW {
        _IRFILTW { w: self }
    }
    #[doc = "Bits 4:6 - IrDA PRS Channel Select"]
    #[inline]
#[inline]     pub fn irprssel(&mut self) -> _IRPRSSELW {
        _IRPRSSELW { w: self }
    }
    #[doc = "Bit 7 - IrDA PRS Channel Enable"]
    #[inline]
#[inline]     pub fn irprsen(&mut self) -> _IRPRSENW {
        _IRPRSENW { w: self }
    }
}
