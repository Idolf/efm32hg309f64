...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> EM4WUENR {
        match value {
            1 => EM4WUENR::A0,
            4 => EM4WUENR::C9,
            8 => EM4WUENR::F1,
...
impl<'a> _EM4WUENW<'a> {
    ...
    #[inline]
#[inline]     pub fn variant(self, variant: EM4WUENW) -> &'a mut W {
...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn em4wuen(&self) -> EM4WUENR {
        EM4WUENR::_from({
            const MASK: u8 = 127;
            const OFFSET: u8 = 0;
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bits 0:6 - EM4 Wake-up enable"]
    #[inline]
#[inline]     pub fn em4wuen(&mut self) -> _EM4WUENW {
        _EM4WUENW { w: self }
    }
}
