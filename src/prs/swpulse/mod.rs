...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[inline]
#[inline]     pub fn ch0pulse(&mut self) -> _CH0PULSEW {
        _CH0PULSEW { w: self }
    }
    #[doc = "Bit 1 - Channel 1 Pulse Generation"]
    #[inline]
#[inline]     pub fn ch1pulse(&mut self) -> _CH1PULSEW {
        _CH1PULSEW { w: self }
    }
    #[doc = "Bit 2 - Channel 2 Pulse Generation"]
    #[inline]
#[inline]     pub fn ch2pulse(&mut self) -> _CH2PULSEW {
        _CH2PULSEW { w: self }
    }
    #[doc = "Bit 3 - Channel 3 Pulse Generation"]
    #[inline]
#[inline]     pub fn ch3pulse(&mut self) -> _CH3PULSEW {
        _CH3PULSEW { w: self }
    }
    #[doc = "Bit 4 - Channel 4 Pulse Generation"]
    #[inline]
#[inline]     pub fn ch4pulse(&mut self) -> _CH4PULSEW {
        _CH4PULSEW { w: self }
    }
    #[doc = "Bit 5 - Channel 5 Pulse Generation"]
    #[inline]
#[inline]     pub fn ch5pulse(&mut self) -> _CH5PULSEW {
        _CH5PULSEW { w: self }
    }
}
