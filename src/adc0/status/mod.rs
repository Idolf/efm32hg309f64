...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> SCANDATASRCR {
        match value {
            0 => SCANDATASRCR::CH0,
            1 => SCANDATASRCR::CH1,
            2 => SCANDATASRCR::CH2,
...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn singleact(&self) -> SINGLEACTR {
        let bits = {
    ...
    #[inline]
#[inline]     pub fn scanact(&self) -> SCANACTR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 1;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn singlerefwarm(&self) -> SINGLEREFWARMR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 8;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn scanrefwarm(&self) -> SCANREFWARMR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 9;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub fn warm(&self) -> WARMR {
    ...
    #[inline]
#[inline]     pub fn singledv(&self) -> SINGLEDVR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 16;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn scandv(&self) -> SCANDVR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 17;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn scandatasrc(&self) -> SCANDATASRCR {
        SCANDATASRCR::_from({
            const MASK: u8 = 7;
            const OFFSET: u8 = 24;
