...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[inline]
#[inline]     pub fn txdata0(&mut self) -> _TXDATA0W {
        _TXDATA0W { w: self }
    }
    #[doc = "Bit 11 - Unblock RX After Transmission"]
    #[inline]
#[inline]     pub fn ubrxat0(&mut self) -> _UBRXAT0W {
        _UBRXAT0W { w: self }
    }
    #[doc = "Bit 12 - Set TXTRI After Transmission"]
    #[inline]
#[inline]     pub fn txtriat0(&mut self) -> _TXTRIAT0W {
        _TXTRIAT0W { w: self }
    }
    #[doc = "Bit 13 - Transmit Data As Break"]
    #[inline]
#[inline]     pub fn txbreak0(&mut self) -> _TXBREAK0W {
        _TXBREAK0W { w: self }
    }
    #[doc = "Bit 14 - Clear TXEN After Transmission"]
    #[inline]
#[inline]     pub fn txdisat0(&mut self) -> _TXDISAT0W {
        _TXDISAT0W { w: self }
    }
    #[doc = "Bit 15 - Enable RX After Transmission"]
    #[inline]
#[inline]     pub fn rxenat0(&mut self) -> _RXENAT0W {
        _RXENAT0W { w: self }
    }
    #[doc = "Bits 16:24 - TX Data"]
    #[inline]
#[inline]     pub fn txdata1(&mut self) -> _TXDATA1W {
        _TXDATA1W { w: self }
    }
    #[doc = "Bit 27 - Unblock RX After Transmission"]
    #[inline]
#[inline]     pub fn ubrxat1(&mut self) -> _UBRXAT1W {
        _UBRXAT1W { w: self }
    }
    #[doc = "Bit 28 - Set TXTRI After Transmission"]
    #[inline]
#[inline]     pub fn txtriat1(&mut self) -> _TXTRIAT1W {
        _TXTRIAT1W { w: self }
    }
    #[doc = "Bit 29 - Transmit Data As Break"]
    #[inline]
#[inline]     pub fn txbreak1(&mut self) -> _TXBREAK1W {
        _TXBREAK1W { w: self }
    }
    #[doc = "Bit 30 - Clear TXEN After Transmission"]
    #[inline]
#[inline]     pub fn txdisat1(&mut self) -> _TXDISAT1W {
        _TXDISAT1W { w: self }
    }
    #[doc = "Bit 31 - Enable RX After Transmission"]
    #[inline]
#[inline]     pub fn rxenat1(&mut self) -> _RXENAT1W {
        _RXENAT1W { w: self }
    }
}
