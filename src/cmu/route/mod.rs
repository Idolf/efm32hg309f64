...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn clkout0pen(&self) -> CLKOUT0PENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 0;
    ...
    #[inline]
#[inline]     pub fn clkout1pen(&self) -> CLKOUT1PENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 1;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bit 0 - CLKOUT0 Pin Enable"]
    #[inline]
#[inline]     pub fn clkout0pen(&mut self) -> _CLKOUT0PENW {
        _CLKOUT0PENW { w: self }
    }
    #[doc = "Bit 1 - CLKOUT1 Pin Enable"]
    #[inline]
#[inline]     pub fn clkout1pen(&mut self) -> _CLKOUT1PENW {
        _CLKOUT1PENW { w: self }
    }
    #[doc = "Bits 2:4 - I/O Location"]
    #[inline]
