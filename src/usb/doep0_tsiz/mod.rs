...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> RXDPIDSUPCNTR {
        match value {
...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn xfersize(&self) -> XFERSIZER {
        let bits = {
            const MASK: u32 = 524287;
            const OFFSET: u8 = 0;
    ...
    #[inline]
#[inline]     pub fn pktcnt(&self) -> PKTCNTR {
        let bits = {
            const MASK: u16 = 1023;
            const OFFSET: u8 = 19;
    ...
    #[inline]
#[inline]     pub fn rxdpidsupcnt(&self) -> RXDPIDSUPCNTR {
        RXDPIDSUPCNTR::_from({
            const MASK: u8 = 3;
            const OFFSET: u8 = 29;
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bits 0:18 - Transfer Size"]
    #[inline]
#[inline]     pub fn xfersize(&mut self) -> _XFERSIZEW {
        _XFERSIZEW { w: self }
    }
    #[doc = "Bits 19:28 - Packet Count"]
    #[inline]
#[inline]     pub fn pktcnt(&mut self) -> _PKTCNTW {
        _PKTCNTW { w: self }
    }
}
