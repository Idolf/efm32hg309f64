...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[inline]
#[inline]     pub fn ch0swreq(&mut self) -> _CH0SWREQW {
        _CH0SWREQW { w: self }
    }
    #[doc = "Bit 1 - Channel 1 Software Request"]
    #[inline]
#[inline]     pub fn ch1swreq(&mut self) -> _CH1SWREQW {
        _CH1SWREQW { w: self }
    }
    #[doc = "Bit 2 - Channel 2 Software Request"]
    #[inline]
#[inline]     pub fn ch2swreq(&mut self) -> _CH2SWREQW {
        _CH2SWREQW { w: self }
    }
    #[doc = "Bit 3 - Channel 3 Software Request"]
    #[inline]
#[inline]     pub fn ch3swreq(&mut self) -> _CH3SWREQW {
        _CH3SWREQW { w: self }
    }
    #[doc = "Bit 4 - Channel 4 Software Request"]
    #[inline]
#[inline]     pub fn ch4swreq(&mut self) -> _CH4SWREQW {
        _CH4SWREQW { w: self }
    }
    #[doc = "Bit 5 - Channel 5 Software Request"]
    #[inline]
#[inline]     pub fn ch5swreq(&mut self) -> _CH5SWREQW {
        _CH5SWREQW { w: self }
    }
}
