...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn inepntxfstaddr(&self) -> INEPNTXFSTADDRR {
        let bits = {
            const MASK: u16 = 2047;
            const OFFSET: u8 = 0;
    ...
    #[inline]
#[inline]     pub fn inepntxfdep(&self) -> INEPNTXFDEPR {
        let bits = {
            const MASK: u16 = 1023;
            const OFFSET: u8 = 16;
            ((self.bits >> OFFSET) & MASK as u32) as u16
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bits 0:10 - IN Endpoint FIFO 1 Transmit RAM Start Address"]
    #[inline]
#[inline]     pub fn inepntxfstaddr(&mut self) -> _INEPNTXFSTADDRW {
        _INEPNTXFSTADDRW { w: self }
    }
    #[doc = "Bits 16:25 - IN Endpoint TxFIFO Depth"]
    #[inline]
#[inline]     pub fn inepntxfdep(&mut self) -> _INEPNTXFDEPW {
