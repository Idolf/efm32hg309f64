...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn ch0pen(&self) -> CH0PENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 0;
    ...
    #[inline]
#[inline]     pub fn ch1pen(&self) -> CH1PENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 1;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn ch2pen(&self) -> CH2PENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 2;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn ch3pen(&self) -> CH3PENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 3;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bit 0 - CH0 Pin Enable"]
    #[inline]
#[inline]     pub fn ch0pen(&mut self) -> _CH0PENW {
        _CH0PENW { w: self }
    }
    #[doc = "Bit 1 - CH1 Pin Enable"]
    #[inline]
#[inline]     pub fn ch1pen(&mut self) -> _CH1PENW {
        _CH1PENW { w: self }
    }
    #[doc = "Bit 2 - CH2 Pin Enable"]
    #[inline]
#[inline]     pub fn ch2pen(&mut self) -> _CH2PENW {
        _CH2PENW { w: self }
    }
    #[doc = "Bit 3 - CH3 Pin Enable"]
    #[inline]
#[inline]     pub fn ch3pen(&mut self) -> _CH3PENW {
        _CH3PENW { w: self }
    }
    #[doc = "Bits 8:10 - I/O Location"]
    #[inline]
