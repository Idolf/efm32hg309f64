...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> S0PRSSELR {
        match value {
            0 => S0PRSSELR::PRSCH0,
            1 => S0PRSSELR::PRSCH1,
            2 => S0PRSSELR::PRSCH2,
...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> S1PRSSELR {
        match value {
            0 => S1PRSSELR::PRSCH0,
            1 => S1PRSSELR::PRSCH1,
            2 => S1PRSSELR::PRSCH2,
...
impl<'a> _S0PRSSELW<'a> {
    ...
    #[inline]
#[inline]     pub fn variant(self, variant: S0PRSSELW) -> &'a mut W {
...
impl<'a> _S1PRSSELW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
#[inline]     pub fn variant(self, variant: S1PRSSELW) -> &'a mut W {
        unsafe { self.bits(variant._bits()) }
    }
    #[doc = "PRS Channel 0 selected."]
    #[inline]
...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn s0prssel(&self) -> S0PRSSELR {
        S0PRSSELR::_from({
            const MASK: u8 = 7;
            const OFFSET: u8 = 0;
    ...
    #[inline]
#[inline]     pub fn s0prsen(&self) -> S0PRSENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 4;
    ...
    #[inline]
#[inline]     pub fn s1prssel(&self) -> S1PRSSELR {
        S1PRSSELR::_from({
            const MASK: u8 = 7;
            const OFFSET: u8 = 6;
            ((self.bits >> OFFSET) & MASK as u32) as u8
    ...
    #[inline]
#[inline]     pub fn s1prsen(&self) -> S1PRSENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 10;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bits 0:2 - S0IN PRS Channel Select"]
    #[inline]
#[inline]     pub fn s0prssel(&mut self) -> _S0PRSSELW {
        _S0PRSSELW { w: self }
    }
    #[doc = "Bit 4 - S0IN PRS Enable"]
    #[inline]
#[inline]     pub fn s0prsen(&mut self) -> _S0PRSENW {
        _S0PRSENW { w: self }
    }
    #[doc = "Bits 6:8 - S1IN PRS Channel Select"]
    #[inline]
#[inline]     pub fn s1prssel(&mut self) -> _S1PRSSELW {
        _S1PRSSELW { w: self }
    }
    #[doc = "Bit 10 - S1IN PRS Enable"]
    #[inline]
#[inline]     pub fn s1prsen(&mut self) -> _S1PRSENW {
        _S1PRSENW { w: self }
    }
}
