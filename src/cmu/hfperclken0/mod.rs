...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn timer0(&self) -> TIMER0R {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 0;
    ...
    #[inline]
#[inline]     pub fn timer1(&self) -> TIMER1R {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 1;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn timer2(&self) -> TIMER2R {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 2;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn usart0(&self) -> USART0R {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 3;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn usart1(&self) -> USART1R {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 4;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn acmp0(&self) -> ACMP0R {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 5;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub fn prs(&self) -> PRSR {
    ...
    #[inline]
#[inline]     pub fn idac0(&self) -> IDAC0R {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 7;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bit 0 - Timer 0 Clock Enable"]
    #[inline]
#[inline]     pub fn timer0(&mut self) -> _TIMER0W {
        _TIMER0W { w: self }
    }
    #[doc = "Bit 1 - Timer 1 Clock Enable"]
    #[inline]
#[inline]     pub fn timer1(&mut self) -> _TIMER1W {
        _TIMER1W { w: self }
    }
    #[doc = "Bit 2 - Timer 2 Clock Enable"]
    #[inline]
#[inline]     pub fn timer2(&mut self) -> _TIMER2W {
        _TIMER2W { w: self }
    }
    #[doc = "Bit 3 - Universal Synchronous/Asynchronous Receiver/Transmitter 0 Clock Enable"]
    #[inline]
#[inline]     pub fn usart0(&mut self) -> _USART0W {
        _USART0W { w: self }
    }
    #[doc = "Bit 4 - Universal Synchronous/Asynchronous Receiver/Transmitter 1 Clock Enable"]
    #[inline]
#[inline]     pub fn usart1(&mut self) -> _USART1W {
        _USART1W { w: self }
    }
    #[doc = "Bit 5 - Analog Comparator 0 Clock Enable"]
    #[inline]
#[inline]     pub fn acmp0(&mut self) -> _ACMP0W {
        _ACMP0W { w: self }
    }
    #[doc = "Bit 6 - Peripheral Reflex System Clock Enable"]
    #[inline]
#[inline]     pub fn prs(&mut self) -> _PRSW {
    ...
    #[doc = "Bit 7 - Current Digital to Analog Converter 0 Clock Enable"]
    #[inline]
#[inline]     pub fn idac0(&mut self) -> _IDAC0W {
        _IDAC0W { w: self }
    }
    #[doc = "Bit 8 - General purpose Input/Output Clock Enable"]
    #[inline]
#[inline]     pub fn gpio(&mut self) -> _GPIOW {
        _GPIOW { w: self }
    }
    #[doc = "Bit 9 - Voltage Comparator Clock Enable"]
    #[inline]
#[inline]     pub fn vcmp(&mut self) -> _VCMPW {
        _VCMPW { w: self }
    }
    #[doc = "Bit 10 - Analog to Digital Converter 0 Clock Enable"]
    #[inline]
#[inline]     pub fn adc0(&mut self) -> _ADC0W {
        _ADC0W { w: self }
    }
    #[doc = "Bit 11 - I2C 0 Clock Enable"]
    #[inline]
#[inline]     pub fn i2c0(&mut self) -> _I2C0W {
        _I2C0W { w: self }
    }
}
