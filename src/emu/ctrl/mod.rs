...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn emvreg(&self) -> EMVREGR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 0;
    ...
    #[inline]
#[inline]     pub fn em2block(&self) -> EM2BLOCKR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 1;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn em4ctrl(&self) -> EM4CTRLR {
        let bits = {
            const MASK: u8 = 3;
            const OFFSET: u8 = 2;
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bit 0 - Energy Mode Voltage Regulator Control"]
    #[inline]
#[inline]     pub fn emvreg(&mut self) -> _EMVREGW {
        _EMVREGW { w: self }
    }
    #[doc = "Bit 1 - Energy Mode 2 Block"]
    #[inline]
#[inline]     pub fn em2block(&mut self) -> _EM2BLOCKW {
        _EM2BLOCKW { w: self }
    }
    #[doc = "Bits 2:3 - Energy Mode 4 Control"]
    #[inline]
#[inline]     pub fn em4ctrl(&mut self) -> _EM4CTRLW {
        _EM4CTRLW { w: self }
    }
}
