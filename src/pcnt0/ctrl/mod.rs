...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> CNTEVR {
        match value {
            0 => CNTEVR::BOTH,
            1 => CNTEVR::UP,
            2 => CNTEVR::DOWN,
...
#[inline]     pub fn is_both(&self) -> bool {
    ...
    #[inline]
#[inline]     pub fn is_up(&self) -> bool {
        *self == CNTEVR::UP
    }
    #[doc = "Checks if the value of the field is `DOWN`"]
    #[inline]
#[inline]     pub fn is_down(&self) -> bool {
        *self == CNTEVR::DOWN
    }
...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> AUXCNTEVR {
        match value {
            0 => AUXCNTEVR::NONE,
            1 => AUXCNTEVR::UP,
            2 => AUXCNTEVR::DOWN,
...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> TCCMODER {
        match value {
            0 => TCCMODER::DISABLED,
            1 => TCCMODER::LFA,
            2 => TCCMODER::PRS,
...
#[inline]     pub fn is_disabled(&self) -> bool {
    ...
    #[inline]
#[inline]     pub fn is_lfa(&self) -> bool {
        *self == TCCMODER::LFA
    }
    #[doc = "Checks if the value of the field is `PRS`"]
    #[inline]
#[inline]     pub fn is_prs(&self) -> bool {
        *self == TCCMODER::PRS
    }
}
...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> TCCPRESCR {
        match value {
            0 => TCCPRESCR::DIV1,
            1 => TCCPRESCR::DIV2,
            2 => TCCPRESCR::DIV4,
...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> TCCCOMPR {
        match value {
            0 => TCCCOMPR::LTOE,
            1 => TCCCOMPR::GTOE,
            2 => TCCCOMPR::RANGE,
    ...
    #[inline]
#[inline]     pub fn is_ltoe(&self) -> bool {
        *self == TCCCOMPR::LTOE
    }
    #[doc = "Checks if the value of the field is `GTOE`"]
    #[inline]
#[inline]     pub fn is_gtoe(&self) -> bool {
        *self == TCCCOMPR::GTOE
    }
    #[doc = "Checks if the value of the field is `RANGE`"]
    #[inline]
#[inline]     pub fn is_range(&self) -> bool {
        *self == TCCCOMPR::RANGE
    }
}
#[doc = r" Value of the field"]
...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> TCCPRSSELR {
        match value {
            0 => TCCPRSSELR::PRSCH0,
            1 => TCCPRSSELR::PRSCH1,
            2 => TCCPRSSELR::PRSCH2,
...
#[inline]     pub fn variant(self, variant: MODEW) -> &'a mut W {
    ...
    #[doc = "The module is disabled."]
    #[inline]
#[inline]     pub fn disable(self) -> &'a mut W {
        self.variant(MODEW::DISABLE)
    }
    #[doc = "Single input LFACLK oversampling mode (available in EM0-EM2)."]
    #[inline]
#[inline]     pub fn ovssingle(self) -> &'a mut W {
        self.variant(MODEW::OVSSINGLE)
    }
    #[doc = "Externally clocked single input counter mode (available in EM0-EM3)."]
    #[inline]
#[inline]     pub fn extclksingle(self) -> &'a mut W {
        self.variant(MODEW::EXTCLKSINGLE)
    }
    #[doc = "Externally clocked quadrature decoder mode (available in EM0-EM3)."]
    #[inline]
#[inline]     pub fn extclkquad(self) -> &'a mut W {
...
impl<'a> _CNTEVW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
#[inline]     pub fn variant(self, variant: CNTEVW) -> &'a mut W {
        {
            self.bits(variant._bits())
        }
    }
...
#[inline]     pub fn both(self) -> &'a mut W {
    ...
    #[doc = "Only counts up on up-count events."]
    #[inline]
#[inline]     pub fn up(self) -> &'a mut W {
        self.variant(CNTEVW::UP)
    }
    #[doc = "Only counts down on down-count events."]
    #[inline]
#[inline]     pub fn down(self) -> &'a mut W {
...
impl<'a> _AUXCNTEVW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
#[inline]     pub fn variant(self, variant: AUXCNTEVW) -> &'a mut W {
        {
            self.bits(variant._bits())
        }
    }
...
impl<'a> _TCCMODEW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
#[inline]     pub fn variant(self, variant: TCCMODEW) -> &'a mut W {
...
#[inline]     pub fn disabled(self) -> &'a mut W {
    ...
    #[doc = "Compare and clear performed on each (optionally prescaled) LFA clock cycle."]
    #[inline]
#[inline]     pub fn lfa(self) -> &'a mut W {
        self.variant(TCCMODEW::LFA)
    }
    #[doc = "Compare and clear performed on positive PRS edges."]
    #[inline]
#[inline]     pub fn prs(self) -> &'a mut W {
...
impl<'a> _TCCPRESCW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
#[inline]     pub fn variant(self, variant: TCCPRESCW) -> &'a mut W {
        {
            self.bits(variant._bits())
        }
    }
...
impl<'a> _TCCCOMPW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
#[inline]     pub fn variant(self, variant: TCCCOMPW) -> &'a mut W {
        unsafe { self.bits(variant._bits()) }
    }
    #[doc = "Compare match if PCNT_CNT is less than, or equal to PCNT_TOP."]
    #[inline]
#[inline]     pub fn ltoe(self) -> &'a mut W {
        self.variant(TCCCOMPW::LTOE)
    }
    #[doc = "Compare match if PCNT_CNT is greater than or equal to PCNT_TOP."]
    #[inline]
#[inline]     pub fn gtoe(self) -> &'a mut W {
        self.variant(TCCCOMPW::GTOE)
    }
    #[doc = "Compare match if PCNT_CNT is less than, or equal to PCNT_TOP[15:8]], and greater than, or equal to PCNT_TOP[7:0]."]
    #[inline]
#[inline]     pub fn range(self) -> &'a mut W {
...
impl<'a> _TCCPRSSELW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
#[inline]     pub fn variant(self, variant: TCCPRSSELW) -> &'a mut W {
        unsafe { self.bits(variant._bits()) }
    }
    #[doc = "PRS Channel 0 selected."]
    #[inline]
...
#[inline]     pub fn mode(&self) -> MODER {
    ...
    #[inline]
#[inline]     pub fn cntdir(&self) -> CNTDIRR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 2;
...
#[inline]     pub fn filt(&self) -> FILTR {
    ...
    #[inline]
#[inline]     pub fn rsten(&self) -> RSTENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 5;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn auxcntrsten(&self) -> AUXCNTRSTENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 6;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub fn hyst(&self) -> HYSTR {
    ...
    #[inline]
#[inline]     pub fn s1cdir(&self) -> S1CDIRR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 9;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn cntev(&self) -> CNTEVR {
        CNTEVR::_from({
            const MASK: u8 = 3;
            const OFFSET: u8 = 10;
            ((self.bits >> OFFSET) & MASK as u32) as u8
    ...
    #[inline]
#[inline]     pub fn auxcntev(&self) -> AUXCNTEVR {
        AUXCNTEVR::_from({
            const MASK: u8 = 3;
            const OFFSET: u8 = 14;
            ((self.bits >> OFFSET) & MASK as u32) as u8
    ...
    #[inline]
#[inline]     pub fn tccmode(&self) -> TCCMODER {
        TCCMODER::_from({
            const MASK: u8 = 3;
            const OFFSET: u8 = 18;
            ((self.bits >> OFFSET) & MASK as u32) as u8
    ...
    #[inline]
#[inline]     pub fn tccpresc(&self) -> TCCPRESCR {
        TCCPRESCR::_from({
            const MASK: u8 = 3;
            const OFFSET: u8 = 22;
            ((self.bits >> OFFSET) & MASK as u32) as u8
    ...
    #[inline]
#[inline]     pub fn tcccomp(&self) -> TCCCOMPR {
        TCCCOMPR::_from({
            const MASK: u8 = 3;
            const OFFSET: u8 = 25;
            ((self.bits >> OFFSET) & MASK as u32) as u8
    ...
    #[inline]
#[inline]     pub fn prsgateen(&self) -> PRSGATEENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 27;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn tccprspol(&self) -> TCCPRSPOLR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 28;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn tccprssel(&self) -> TCCPRSSELR {
        TCCPRSSELR::_from({
            const MASK: u8 = 7;
            const OFFSET: u8 = 29;
            ((self.bits >> OFFSET) & MASK as u32) as u8
...
#[inline]     pub fn mode(&mut self) -> _MODEW {
    ...
    #[doc = "Bit 2 - Non-Quadrature Mode Counter Direction Control"]
    #[inline]
#[inline]     pub fn cntdir(&mut self) -> _CNTDIRW {
        _CNTDIRW { w: self }
    }
    #[doc = "Bit 3 - Edge Select"]
    #[inline]
#[inline]     pub fn edge(&mut self) -> _EDGEW {
        _EDGEW { w: self }
    }
    #[doc = "Bit 4 - Enable Digital Pulse Width Filter"]
    #[inline]
#[inline]     pub fn filt(&mut self) -> _FILTW {
    ...
    #[doc = "Bit 5 - Enable PCNT Clock Domain Reset"]
    #[inline]
#[inline]     pub fn rsten(&mut self) -> _RSTENW {
        _RSTENW { w: self }
    }
    #[doc = "Bit 6 - Enable AUXCNT Reset"]
    #[inline]
#[inline]     pub fn auxcntrsten(&mut self) -> _AUXCNTRSTENW {
        _AUXCNTRSTENW { w: self }
    }
    #[doc = "Bit 8 - Enable Hysteresis"]
    #[inline]
#[inline]     pub fn hyst(&mut self) -> _HYSTW {
        _HYSTW { w: self }
    }
    #[doc = "Bit 9 - Count direction determined by S1"]
    #[inline]
#[inline]     pub fn s1cdir(&mut self) -> _S1CDIRW {
        _S1CDIRW { w: self }
    }
    #[doc = "Bits 10:11 - Controls when the counter counts"]
    #[inline]
#[inline]     pub fn cntev(&mut self) -> _CNTEVW {
        _CNTEVW { w: self }
    }
    #[doc = "Bits 14:15 - Controls when the auxiliary counter counts"]
    #[inline]
#[inline]     pub fn auxcntev(&mut self) -> _AUXCNTEVW {
        _AUXCNTEVW { w: self }
    }
    #[doc = "Bits 18:19 - Sets the mode for triggered compare and clear"]
    #[inline]
#[inline]     pub fn tccmode(&mut self) -> _TCCMODEW {
        _TCCMODEW { w: self }
    }
    #[doc = "Bits 22:23 - Set the LFA prescaler for triggered compare and clear"]
    #[inline]
#[inline]     pub fn tccpresc(&mut self) -> _TCCPRESCW {
        _TCCPRESCW { w: self }
    }
    #[doc = "Bits 25:26 - Triggered compare and clear compare mode"]
    #[inline]
#[inline]     pub fn tcccomp(&mut self) -> _TCCCOMPW {
        _TCCCOMPW { w: self }
    }
    #[doc = "Bit 27 - PRS gate enable"]
    #[inline]
#[inline]     pub fn prsgateen(&mut self) -> _PRSGATEENW {
        _PRSGATEENW { w: self }
    }
    #[doc = "Bit 28 - TCC PRS polarity select"]
    #[inline]
#[inline]     pub fn tccprspol(&mut self) -> _TCCPRSPOLW {
        _TCCPRSPOLW { w: self }
    }
    #[doc = "Bits 29:31 - TCC PRS Channel Select"]
    #[inline]
#[inline]     pub fn tccprssel(&mut self) -> _TCCPRSSELW {
        _TCCPRSSELW { w: self }
    }
}
