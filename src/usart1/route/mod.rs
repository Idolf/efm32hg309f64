...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn rxpen(&self) -> RXPENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 0;
    ...
    #[inline]
#[inline]     pub fn txpen(&self) -> TXPENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 1;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn cspen(&self) -> CSPENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 2;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn clkpen(&self) -> CLKPENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 3;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bit 0 - RX Pin Enable"]
    #[inline]
#[inline]     pub fn rxpen(&mut self) -> _RXPENW {
        _RXPENW { w: self }
    }
    #[doc = "Bit 1 - TX Pin Enable"]
    #[inline]
#[inline]     pub fn txpen(&mut self) -> _TXPENW {
        _TXPENW { w: self }
    }
    #[doc = "Bit 2 - CS Pin Enable"]
    #[inline]
#[inline]     pub fn cspen(&mut self) -> _CSPENW {
        _CSPENW { w: self }
    }
    #[doc = "Bit 3 - CLK Pin Enable"]
    #[inline]
#[inline]     pub fn clkpen(&mut self) -> _CLKPENW {
        _CLKPENW { w: self }
    }
    #[doc = "Bits 8:10 - I/O Location"]
    #[inline]
