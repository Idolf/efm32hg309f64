...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> MPSR {
        match value {
            0 => MPSR::_64B,
            1 => MPSR::_32B,
            2 => MPSR::_16B,
...
impl<'a> _MPSW<'a> {
    ...
    #[inline]
#[inline]     pub fn variant(self, variant: MPSW) -> &'a mut W {
        {
    ...
    #[doc = "64 bytes."]
    #[inline]
#[inline]     pub fn _64b(self) -> &'a mut W {
        self.variant(MPSW::_64B)
    }
    #[doc = "32 bytes."]
    #[inline]
#[inline]     pub fn _32b(self) -> &'a mut W {
        self.variant(MPSW::_32B)
    }
    #[doc = "16 bytes."]
    #[inline]
#[inline]     pub fn _16b(self) -> &'a mut W {
        self.variant(MPSW::_16B)
    }
    #[doc = "8 bytes."]
    #[inline]
#[inline]     pub fn _8b(self) -> &'a mut W {
