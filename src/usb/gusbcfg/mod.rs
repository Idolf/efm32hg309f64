...
#[doc = r" Proxy"]
pub struct _TERMSELDLPULSEW<'a> {
    w: &'a mut W,
}
impl<'a> _TERMSELDLPULSEW<'a> {
    #[doc = r" Sets the field bit"]
#[inline]     pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _CORRUPTTXPKTW<'a> {
    w: &'a mut W,
}
impl<'a> _CORRUPTTXPKTW<'a> {
    #[doc = r" Sets the field bit"]
#[inline]     pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn toutcal(&self) -> TOUTCALR {
        let bits = {
            const MASK: u8 = 7;
            const OFFSET: u8 = 0;
    ...
    #[inline]
#[inline]     pub fn fsintf(&self) -> FSINTFR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 5;
    ...
    #[inline]
#[inline]     pub fn usbtrdtim(&self) -> USBTRDTIMR {
        let bits = {
            const MASK: u8 = 15;
            const OFFSET: u8 = 10;
            ((self.bits >> OFFSET) & MASK as u32) as u8
    ...
    #[inline]
#[inline]     pub fn termseldlpulse(&self) -> TERMSELDLPULSER {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 22;
            ((self.bits >> OFFSET) & MASK as u32) != 0
        };
        TERMSELDLPULSER { bits }
    }
    #[doc = "Bit 28 - Tx End Delay"]
    #[inline]
#[inline]     pub fn txenddelay(&self) -> TXENDDELAYR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 28;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bits 0:2 - Timeout Calibration"]
    #[inline]
#[inline]     pub fn toutcal(&mut self) -> _TOUTCALW {
        _TOUTCALW { w: self }
    }
    #[doc = "Bit 5 - Full-Speed Serial Interface Select"]
    #[inline]
#[inline]     pub fn fsintf(&mut self) -> _FSINTFW {
        _FSINTFW { w: self }
    }
    #[doc = "Bits 10:13 - USB Turnaround Time"]
    #[inline]
#[inline]     pub fn usbtrdtim(&mut self) -> _USBTRDTIMW {
        _USBTRDTIMW { w: self }
    }
    #[doc = "Bit 22 - TermSel DLine Pulsing Selection"]
    #[inline]
#[inline]     pub fn termseldlpulse(&mut self) -> _TERMSELDLPULSEW {
        _TERMSELDLPULSEW { w: self }
    }
    #[doc = "Bit 28 - Tx End Delay"]
    #[inline]
#[inline]     pub fn txenddelay(&mut self) -> _TXENDDELAYW {
        _TXENDDELAYW { w: self }
    }
    #[doc = "Bit 31 - Corrupt Tx packet"]
    #[inline]
#[inline]     pub fn corrupttxpkt(&mut self) -> _CORRUPTTXPKTW {
