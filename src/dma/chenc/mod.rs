...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[inline]
#[inline]     pub fn ch0enc(&mut self) -> _CH0ENCW {
        _CH0ENCW { w: self }
    }
    #[doc = "Bit 1 - Channel 1 Enable Clear"]
    #[inline]
#[inline]     pub fn ch1enc(&mut self) -> _CH1ENCW {
        _CH1ENCW { w: self }
    }
    #[doc = "Bit 2 - Channel 2 Enable Clear"]
    #[inline]
#[inline]     pub fn ch2enc(&mut self) -> _CH2ENCW {
        _CH2ENCW { w: self }
    }
    #[doc = "Bit 3 - Channel 3 Enable Clear"]
    #[inline]
#[inline]     pub fn ch3enc(&mut self) -> _CH3ENCW {
        _CH3ENCW { w: self }
    }
    #[doc = "Bit 4 - Channel 4 Enable Clear"]
    #[inline]
#[inline]     pub fn ch4enc(&mut self) -> _CH4ENCW {
        _CH4ENCW { w: self }
    }
    #[doc = "Bit 5 - Channel 5 Enable Clear"]
    #[inline]
#[inline]     pub fn ch5enc(&mut self) -> _CH5ENCW {
        _CH5ENCW { w: self }
    }
}
