...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn rxdata0(&self) -> RXDATA0R {
        let bits = {
            const MASK: u16 = 511;
            const OFFSET: u8 = 0;
    ...
    #[inline]
#[inline]     pub fn perr0(&self) -> PERR0R {
        let bits = {
    ...
    #[inline]
#[inline]     pub fn ferr0(&self) -> FERR0R {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 15;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn rxdata1(&self) -> RXDATA1R {
        let bits = {
            const MASK: u16 = 511;
            const OFFSET: u8 = 16;
            ((self.bits >> OFFSET) & MASK as u32) as u16
    ...
    #[inline]
#[inline]     pub fn perr1(&self) -> PERR1R {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 30;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn ferr1(&self) -> FERR1R {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 31;
            ((self.bits >> OFFSET) & MASK as u32) != 0
