...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> FORMATR {
        match value {
            0 => FORMATR::W32D32,
            1 => FORMATR::W32D24M,
            2 => FORMATR::W32D24,
...
impl<'a> _FORMATW<'a> {
    ...
    #[inline]
#[inline]     pub fn variant(self, variant: FORMATW) -> &'a mut W {
        {
    ...
    #[doc = "32-bit word, 32-bit data"]
    #[inline]
#[inline]     pub fn w32d32(self) -> &'a mut W {
        self.variant(FORMATW::W32D32)
    }
    #[doc = "32-bit word, 32-bit data with 8 lsb masked"]
    #[inline]
#[inline]     pub fn w32d24m(self) -> &'a mut W {
        self.variant(FORMATW::W32D24M)
    }
    #[doc = "32-bit word, 24-bit data"]
    #[inline]
#[inline]     pub fn w32d24(self) -> &'a mut W {
        self.variant(FORMATW::W32D24)
    }
    #[doc = "32-bit word, 16-bit data"]
    #[inline]
#[inline]     pub fn w32d16(self) -> &'a mut W {
        self.variant(FORMATW::W32D16)
    }
    #[doc = "32-bit word, 8-bit data"]
    #[inline]
#[inline]     pub fn w32d8(self) -> &'a mut W {
        self.variant(FORMATW::W32D8)
    }
    #[doc = "16-bit word, 16-bit data"]
    #[inline]
#[inline]     pub fn w16d16(self) -> &'a mut W {
        self.variant(FORMATW::W16D16)
    }
    #[doc = "16-bit word, 8-bit data"]
    #[inline]
#[inline]     pub fn w16d8(self) -> &'a mut W {
        self.variant(FORMATW::W16D8)
    }
    #[doc = "8-bit word, 8-bit data"]
    #[inline]
#[inline]     pub fn w8d8(self) -> &'a mut W {
...
#[inline]     pub fn mono(&self) -> MONOR {
    ...
    #[inline]
#[inline]     pub fn justify(&self) -> JUSTIFYR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 2;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn dmasplit(&self) -> DMASPLITR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 3;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn delay(&self) -> DELAYR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 4;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn format(&self) -> FORMATR {
        FORMATR::_from({
            const MASK: u8 = 7;
            const OFFSET: u8 = 8;
...
#[inline]     pub fn en(&mut self) -> _ENW {
    ...
    #[doc = "Bit 1 - Stero or Mono"]
    #[inline]
#[inline]     pub fn mono(&mut self) -> _MONOW {
        _MONOW { w: self }
    }
    #[doc = "Bit 2 - Justification of I2S Data"]
    #[inline]
#[inline]     pub fn justify(&mut self) -> _JUSTIFYW {
        _JUSTIFYW { w: self }
    }
    #[doc = "Bit 3 - Separate DMA Request For Left/Right Data"]
    #[inline]
#[inline]     pub fn dmasplit(&mut self) -> _DMASPLITW {
        _DMASPLITW { w: self }
    }
    #[doc = "Bit 4 - Delay on I2S data"]
    #[inline]
#[inline]     pub fn delay(&mut self) -> _DELAYW {
        _DELAYW { w: self }
    }
    #[doc = "Bits 8:10 - I2S Word Format"]
    #[inline]
#[inline]     pub fn format(&mut self) -> _FORMATW {
        _FORMATW { w: self }
    }
}
