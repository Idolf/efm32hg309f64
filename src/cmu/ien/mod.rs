...
#[inline]     pub fn auxhfrcordy(&self) -> AUXHFRCORDYR {
    ...
    #[inline]
#[inline]     pub fn calrdy(&self) -> CALRDYR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 5;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn calof(&self) -> CALOFR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 6;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub fn ushfrcordy(&self) -> USHFRCORDYR {
    ...
    #[inline]
#[inline]     pub fn usbchfoscsel(&self) -> USBCHFOSCSELR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 9;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bit 0 - HFRCO Ready Interrupt Enable"]
    #[inline]
#[inline]     pub fn hfrcordy(&mut self) -> _HFRCORDYW {
        _HFRCORDYW { w: self }
    }
    #[doc = "Bit 1 - HFXO Ready Interrupt Enable"]
    #[inline]
#[inline]     pub fn hfxordy(&mut self) -> _HFXORDYW {
        _HFXORDYW { w: self }
    }
    #[doc = "Bit 2 - LFRCO Ready Interrupt Enable"]
    #[inline]
#[inline]     pub fn lfrcordy(&mut self) -> _LFRCORDYW {
        _LFRCORDYW { w: self }
    }
    #[doc = "Bit 3 - LFXO Ready Interrupt Enable"]
    #[inline]
#[inline]     pub fn lfxordy(&mut self) -> _LFXORDYW {
        _LFXORDYW { w: self }
    }
    #[doc = "Bit 4 - AUXHFRCO Ready Interrupt Enable"]
    #[inline]
#[inline]     pub fn auxhfrcordy(&mut self) -> _AUXHFRCORDYW {
        _AUXHFRCORDYW { w: self }
    }
    #[doc = "Bit 5 - Calibration Ready Interrupt Enable"]
    #[inline]
#[inline]     pub fn calrdy(&mut self) -> _CALRDYW {
        _CALRDYW { w: self }
    }
    #[doc = "Bit 6 - Calibration Overflow Interrupt Enable"]
    #[inline]
#[inline]     pub fn calof(&mut self) -> _CALOFW {
        _CALOFW { w: self }
    }
    #[doc = "Bit 8 - USHFRCO Ready Interrupt Enable"]
    #[inline]
#[inline]     pub fn ushfrcordy(&mut self) -> _USHFRCORDYW {
        _USHFRCORDYW { w: self }
    }
    #[doc = "Bit 9 - USBC HF-oscillator Selected Interrupt Flag Clear"]
    #[inline]
#[inline]     pub fn usbchfoscsel(&mut self) -> _USBCHFOSCSELW {
