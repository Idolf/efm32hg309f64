...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> HYSTSELR {
        match value {
            0 => HYSTSELR::HYST0,
            1 => HYSTSELR::HYST1,
            2 => HYSTSELR::HYST2,
...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> WARMTIMER {
        match value {
...
#[inline]     pub fn is_256cycles(&self) -> bool {
    ...
    #[inline]
#[inline]     pub fn is_512cycles(&self) -> bool {
...
impl<'a> _HYSTSELW<'a> {
    ...
    #[inline]
#[inline]     pub fn variant(self, variant: HYSTSELW) -> &'a mut W {
        {
    ...
    #[doc = "No hysteresis."]
    #[inline]
#[inline]     pub fn hyst0(self) -> &'a mut W {
        self.variant(HYSTSELW::HYST0)
    }
    #[doc = "~15 mV hysteresis."]
    #[inline]
#[inline]     pub fn hyst1(self) -> &'a mut W {
        self.variant(HYSTSELW::HYST1)
    }
    #[doc = "~22 mV hysteresis."]
    #[inline]
#[inline]     pub fn hyst2(self) -> &'a mut W {
        self.variant(HYSTSELW::HYST2)
    }
    #[doc = "~29 mV hysteresis."]
    #[inline]
#[inline]     pub fn hyst3(self) -> &'a mut W {
        self.variant(HYSTSELW::HYST3)
    }
    #[doc = "~36 mV hysteresis."]
    #[inline]
#[inline]     pub fn hyst4(self) -> &'a mut W {
        self.variant(HYSTSELW::HYST4)
    }
    #[doc = "~43 mV hysteresis."]
    #[inline]
#[inline]     pub fn hyst5(self) -> &'a mut W {
        self.variant(HYSTSELW::HYST5)
    }
    #[doc = "~50 mV hysteresis."]
    #[inline]
#[inline]     pub fn hyst6(self) -> &'a mut W {
        self.variant(HYSTSELW::HYST6)
    }
    #[doc = "~57 mV hysteresis."]
    #[inline]
#[inline]     pub fn hyst7(self) -> &'a mut W {
...
impl<'a> _WARMTIMEW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
#[inline]     pub fn variant(self, variant: WARMTIMEW) -> &'a mut W {
        {
            self.bits(variant._bits())
        }
    }
...
#[inline]     pub fn _256cycles(self) -> &'a mut W {
    ...
    #[doc = "512 HFPERCLK cycles."]
    #[inline]
#[inline]     pub fn _512cycles(self) -> &'a mut W {
...
#[inline]     pub fn en(&self) -> ENR {
    ...
    #[inline]
#[inline]     pub fn muxen(&self) -> MUXENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 1;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn inactval(&self) -> INACTVALR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 2;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn gpioinv(&self) -> GPIOINVR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 3;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn hystsel(&self) -> HYSTSELR {
        HYSTSELR::_from({
            const MASK: u8 = 7;
            const OFFSET: u8 = 4;
    ...
    #[inline]
#[inline]     pub fn warmtime(&self) -> WARMTIMER {
        WARMTIMER::_from({
            const MASK: u8 = 7;
            const OFFSET: u8 = 8;
            ((self.bits >> OFFSET) & MASK as u32) as u8
    ...
    #[inline]
#[inline]     pub fn irise(&self) -> IRISER {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 16;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn ifall(&self) -> IFALLR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 17;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn biasprog(&self) -> BIASPROGR {
        let bits = {
            const MASK: u8 = 15;
            const OFFSET: u8 = 24;
            ((self.bits >> OFFSET) & MASK as u32) as u8
    ...
    #[inline]
#[inline]     pub fn halfbias(&self) -> HALFBIASR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 30;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn fullbias(&self) -> FULLBIASR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 31;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bit 0 - Analog Comparator Enable"]
    #[inline]
#[inline]     pub fn en(&mut self) -> _ENW {
        _ENW { w: self }
    }
    #[doc = "Bit 1 - Input Mux Enable"]
    #[inline]
#[inline]     pub fn muxen(&mut self) -> _MUXENW {
        _MUXENW { w: self }
    }
    #[doc = "Bit 2 - Inactive Value"]
    #[inline]
#[inline]     pub fn inactval(&mut self) -> _INACTVALW {
        _INACTVALW { w: self }
    }
    #[doc = "Bit 3 - Comparator GPIO Output Invert"]
    #[inline]
#[inline]     pub fn gpioinv(&mut self) -> _GPIOINVW {
        _GPIOINVW { w: self }
    }
    #[doc = "Bits 4:6 - Hysteresis Select"]
    #[inline]
#[inline]     pub fn hystsel(&mut self) -> _HYSTSELW {
        _HYSTSELW { w: self }
    }
    #[doc = "Bits 8:10 - Warm-up Time"]
    #[inline]
#[inline]     pub fn warmtime(&mut self) -> _WARMTIMEW {
        _WARMTIMEW { w: self }
    }
    #[doc = "Bit 16 - Rising Edge Interrupt Sense"]
    #[inline]
#[inline]     pub fn irise(&mut self) -> _IRISEW {
        _IRISEW { w: self }
    }
    #[doc = "Bit 17 - Falling Edge Interrupt Sense"]
    #[inline]
#[inline]     pub fn ifall(&mut self) -> _IFALLW {
        _IFALLW { w: self }
    }
    #[doc = "Bits 24:27 - Bias Configuration"]
    #[inline]
#[inline]     pub fn biasprog(&mut self) -> _BIASPROGW {
        _BIASPROGW { w: self }
    }
    #[doc = "Bit 30 - Half Bias Current"]
    #[inline]
#[inline]     pub fn halfbias(&mut self) -> _HALFBIASW {
        _HALFBIASW { w: self }
    }
    #[doc = "Bit 31 - Full Bias Current"]
    #[inline]
#[inline]     pub fn fullbias(&mut self) -> _FULLBIASW {
        _FULLBIASW { w: self }
    }
}
