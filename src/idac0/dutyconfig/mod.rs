...
#[doc = r" Proxy"]
pub struct _DUTYCYCLEENW<'a> {
    w: &'a mut W,
}
impl<'a> _DUTYCYCLEENW<'a> {
...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn dutycycleen(&self) -> DUTYCYCLEENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 0;
    ...
    #[inline]
#[inline]     pub fn em2dutycycledis(&self) -> EM2DUTYCYCLEDISR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 1;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bit 0 - Duty Cycle Enable."]
    #[inline]
#[inline]     pub fn dutycycleen(&mut self) -> _DUTYCYCLEENW {
        _DUTYCYCLEENW { w: self }
    }
    #[doc = "Bit 1 - EM2/EM3 Duty Cycle Disable."]
    #[inline]
#[inline]     pub fn em2dutycycledis(&mut self) -> _EM2DUTYCYCLEDISW {
