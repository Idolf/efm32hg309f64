...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[inline]
#[inline]     pub fn rxen(&mut self) -> _RXENW {
        _RXENW { w: self }
    }
    #[doc = "Bit 1 - Receiver Disable"]
    #[inline]
#[inline]     pub fn rxdis(&mut self) -> _RXDISW {
        _RXDISW { w: self }
    }
    #[doc = "Bit 2 - Transmitter Enable"]
    #[inline]
#[inline]     pub fn txen(&mut self) -> _TXENW {
        _TXENW { w: self }
    }
    #[doc = "Bit 3 - Transmitter Disable"]
    #[inline]
#[inline]     pub fn txdis(&mut self) -> _TXDISW {
        _TXDISW { w: self }
    }
    #[doc = "Bit 4 - Master Enable"]
    #[inline]
#[inline]     pub fn masteren(&mut self) -> _MASTERENW {
        _MASTERENW { w: self }
    }
    #[doc = "Bit 5 - Master Disable"]
    #[inline]
#[inline]     pub fn masterdis(&mut self) -> _MASTERDISW {
        _MASTERDISW { w: self }
    }
    #[doc = "Bit 6 - Receiver Block Enable"]
    #[inline]
#[inline]     pub fn rxblocken(&mut self) -> _RXBLOCKENW {
        _RXBLOCKENW { w: self }
    }
    #[doc = "Bit 7 - Receiver Block Disable"]
    #[inline]
#[inline]     pub fn rxblockdis(&mut self) -> _RXBLOCKDISW {
        _RXBLOCKDISW { w: self }
    }
    #[doc = "Bit 8 - Transmitter Tristate Enable"]
    #[inline]
#[inline]     pub fn txtrien(&mut self) -> _TXTRIENW {
        _TXTRIENW { w: self }
    }
    #[doc = "Bit 9 - Transmitter Tristate Disable"]
    #[inline]
#[inline]     pub fn txtridis(&mut self) -> _TXTRIDISW {
        _TXTRIDISW { w: self }
    }
    #[doc = "Bit 10 - Clear TX"]
    #[inline]
#[inline]     pub fn cleartx(&mut self) -> _CLEARTXW {
        _CLEARTXW { w: self }
    }
    #[doc = "Bit 11 - Clear RX"]
    #[inline]
#[inline]     pub fn clearrx(&mut self) -> _CLEARRXW {
        _CLEARRXW { w: self }
    }
}
