...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn pcnt0clken(&self) -> PCNT0CLKENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 0;
    ...
    #[inline]
#[inline]     pub fn pcnt0clksel(&self) -> PCNT0CLKSELR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 1;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bit 0 - PCNT0 Clock Enable"]
    #[inline]
#[inline]     pub fn pcnt0clken(&mut self) -> _PCNT0CLKENW {
        _PCNT0CLKENW { w: self }
    }
    #[doc = "Bit 1 - PCNT0 Clock Select"]
    #[inline]
#[inline]     pub fn pcnt0clksel(&mut self) -> _PCNT0CLKSELW {
