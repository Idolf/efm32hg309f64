...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> RANGESELR {
        match value {
            0 => RANGESELR::RANGE0,
            1 => RANGESELR::RANGE1,
            2 => RANGESELR::RANGE2,
...
impl<'a> _RANGESELW<'a> {
    ...
    #[inline]
#[inline]     pub fn variant(self, variant: RANGESELW) -> &'a mut W {
        {
    ...
    #[doc = "Current range set to 0 - 1.6 uA."]
    #[inline]
#[inline]     pub fn range0(self) -> &'a mut W {
        self.variant(RANGESELW::RANGE0)
    }
    #[doc = "Current range set to 1.6 - 4.7 uA."]
    #[inline]
#[inline]     pub fn range1(self) -> &'a mut W {
        self.variant(RANGESELW::RANGE1)
    }
    #[doc = "Current range set to 0.5 - 16 uA."]
    #[inline]
#[inline]     pub fn range2(self) -> &'a mut W {
        self.variant(RANGESELW::RANGE2)
    }
    #[doc = "Current range set to 2 - 64 uA."]
    #[inline]
#[inline]     pub fn range3(self) -> &'a mut W {
...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn rangesel(&self) -> RANGESELR {
        RANGESELR::_from({
            const MASK: u8 = 3;
            const OFFSET: u8 = 0;
    ...
    #[inline]
#[inline]     pub fn stepsel(&self) -> STEPSELR {
        let bits = {
            const MASK: u8 = 31;
            const OFFSET: u8 = 8;
            ((self.bits >> OFFSET) & MASK as u32) as u8
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bits 0:1 - Current Range Select"]
    #[inline]
#[inline]     pub fn rangesel(&mut self) -> _RANGESELW {
        _RANGESELW { w: self }
    }
    #[doc = "Bits 8:12 - Current Step Size Select"]
    #[inline]
#[inline]     pub fn stepsel(&mut self) -> _STEPSELW {
        _STEPSELW { w: self }
    }
}
