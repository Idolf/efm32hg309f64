...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> RTCR {
        match value {
            0 => RTCR::DIV1,
            1 => RTCR::DIV2,
            2 => RTCR::DIV4,
...
impl<'a> _RTCW<'a> {
    ...
    #[inline]
#[inline]     pub fn variant(self, variant: RTCW) -> &'a mut W {
        {
...
#[inline]     pub fn div1024(self) -> &'a mut W {
    ...
    #[doc = "LFACLKRTC = LFACLK/2048"]
    #[inline]
#[inline]     pub fn div2048(self) -> &'a mut W {
        self.variant(RTCW::DIV2048)
    }
    #[doc = "LFACLKRTC = LFACLK/4096"]
    #[inline]
#[inline]     pub fn div4096(self) -> &'a mut W {
        self.variant(RTCW::DIV4096)
    }
    #[doc = "LFACLKRTC = LFACLK/8192"]
    #[inline]
#[inline]     pub fn div8192(self) -> &'a mut W {
        self.variant(RTCW::DIV8192)
    }
    #[doc = "LFACLKRTC = LFACLK/16384"]
    #[inline]
#[inline]     pub fn div16384(self) -> &'a mut W {
        self.variant(RTCW::DIV16384)
    }
    #[doc = "LFACLKRTC = LFACLK/32768"]
    #[inline]
#[inline]     pub fn div32768(self) -> &'a mut W {
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bits 0:3 - Real-Time Counter Prescaler"]
    #[inline]
#[inline]     pub fn rtc(&mut self) -> _RTCW {
        _RTCW { w: self }
    }
}
