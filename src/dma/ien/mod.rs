...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn ch0done(&self) -> CH0DONER {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 0;
    ...
    #[inline]
#[inline]     pub fn ch1done(&self) -> CH1DONER {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 1;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn ch2done(&self) -> CH2DONER {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 2;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn ch3done(&self) -> CH3DONER {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 3;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn ch4done(&self) -> CH4DONER {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 4;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn ch5done(&self) -> CH5DONER {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 5;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bit 0 - DMA Channel 0 Complete Interrupt Enable"]
    #[inline]
#[inline]     pub fn ch0done(&mut self) -> _CH0DONEW {
        _CH0DONEW { w: self }
    }
    #[doc = "Bit 1 - DMA Channel 1 Complete Interrupt Enable"]
    #[inline]
#[inline]     pub fn ch1done(&mut self) -> _CH1DONEW {
        _CH1DONEW { w: self }
    }
    #[doc = "Bit 2 - DMA Channel 2 Complete Interrupt Enable"]
    #[inline]
#[inline]     pub fn ch2done(&mut self) -> _CH2DONEW {
        _CH2DONEW { w: self }
    }
    #[doc = "Bit 3 - DMA Channel 3 Complete Interrupt Enable"]
    #[inline]
#[inline]     pub fn ch3done(&mut self) -> _CH3DONEW {
        _CH3DONEW { w: self }
    }
    #[doc = "Bit 4 - DMA Channel 4 Complete Interrupt Enable"]
    #[inline]
#[inline]     pub fn ch4done(&mut self) -> _CH4DONEW {
        _CH4DONEW { w: self }
    }
    #[doc = "Bit 5 - DMA Channel 5 Complete Interrupt Enable"]
    #[inline]
#[inline]     pub fn ch5done(&mut self) -> _CH5DONEW {
        _CH5DONEW { w: self }
    }
    #[doc = "Bit 31 - DMA Error Interrupt Flag Enable"]
    #[inline]
#[inline]     pub fn err(&mut self) -> _ERRW {
        _ERRW { w: self }
    }
}
