...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[inline]
#[inline]     pub fn dtprs0fc(&mut self) -> _DTPRS0FCW {
        _DTPRS0FCW { w: self }
    }
    #[doc = "Bit 1 - DTI PRS1 Fault Clear"]
    #[inline]
#[inline]     pub fn dtprs1fc(&mut self) -> _DTPRS1FCW {
        _DTPRS1FCW { w: self }
    }
    #[doc = "Bit 2 - DTI Debugger Fault Clear"]
    #[inline]
#[inline]     pub fn dtdbgfc(&mut self) -> _DTDBGFCW {
        _DTDBGFCW { w: self }
    }
    #[doc = "Bit 3 - DTI Lockup Fault Clear"]
    #[inline]
#[inline]     pub fn tlockupfc(&mut self) -> _TLOCKUPFCW {
        _TLOCKUPFCW { w: self }
    }
}
