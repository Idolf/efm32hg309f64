...
#[inline]     pub fn bits(&self) -> u8 {
        match *self {
            ...
            HFPERCLKDIVR::HFCLK2 => 1,
            HFPERCLKDIVR::HFCLK4 => 2,
            HFPERCLKDIVR::HFCLK8 => 3,
            HFPERCLKDIVR::HFCLK16 => 4,
            HFPERCLKDIVR::HFCLK32 => 5,
            HFPERCLKDIVR::HFCLK64 => 6,
            HFPERCLKDIVR::HFCLK128 => 7,
            HFPERCLKDIVR::HFCLK256 => 8,
            HFPERCLKDIVR::HFCLK512 => 9,
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> HFPERCLKDIVR {
        match value {
...
impl<'a> _HFPERCLKDIVW<'a> {
    ...
    #[inline]
#[inline]     pub fn variant(self, variant: HFPERCLKDIVW) -> &'a mut W {
...
#[inline]     pub fn hfclk16(self) -> &'a mut W {
    ...
    #[doc = "HFPERCLK = HFCLK/32."]
    #[inline]
#[inline]     pub fn hfclk32(self) -> &'a mut W {
        self.variant(HFPERCLKDIVW::HFCLK32)
    }
    #[doc = "HFPERCLK = HFCLK/64."]
    #[inline]
#[inline]     pub fn hfclk64(self) -> &'a mut W {
        self.variant(HFPERCLKDIVW::HFCLK64)
    }
    #[doc = "HFPERCLK = HFCLK/128."]
    #[inline]
#[inline]     pub fn hfclk128(self) -> &'a mut W {
        self.variant(HFPERCLKDIVW::HFCLK128)
    }
    #[doc = "HFPERCLK = HFCLK/256."]
    #[inline]
#[inline]     pub fn hfclk256(self) -> &'a mut W {
        self.variant(HFPERCLKDIVW::HFCLK256)
    }
    #[doc = "HFPERCLK = HFCLK/512."]
    #[inline]
#[inline]     pub fn hfclk512(self) -> &'a mut W {
...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn hfperclkdiv(&self) -> HFPERCLKDIVR {
        HFPERCLKDIVR::_from({
            const MASK: u8 = 15;
            const OFFSET: u8 = 0;
    ...
    #[inline]
#[inline]     pub fn hfperclken(&self) -> HFPERCLKENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 8;
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bits 0:3 - HFPERCLK Divider"]
    #[inline]
#[inline]     pub fn hfperclkdiv(&mut self) -> _HFPERCLKDIVW {
        _HFPERCLKDIVW { w: self }
    }
    #[doc = "Bit 8 - HFPERCLK Enable"]
    #[inline]
#[inline]     pub fn hfperclken(&mut self) -> _HFPERCLKENW {
        _HFPERCLKENW { w: self }
    }
}
