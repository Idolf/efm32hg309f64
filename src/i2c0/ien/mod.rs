...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn start(&self) -> STARTR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 0;
    ...
    #[inline]
#[inline]     pub fn rstart(&self) -> RSTARTR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 1;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub fn nack(&self) -> NACKR {
    ...
    #[inline]
#[inline]     pub fn mstop(&self) -> MSTOPR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 8;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn arblost(&self) -> ARBLOSTR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 9;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn buserr(&self) -> BUSERRR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 10;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn bushold(&self) -> BUSHOLDR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 11;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub fn clto(&self) -> CLTOR {
    ...
    #[inline]
#[inline]     pub fn sstop(&self) -> SSTOPR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 16;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub fn start(&mut self) -> _STARTW {
    ...
    #[doc = "Bit 1 - Repeated START condition Interrupt Enable"]
    #[inline]
#[inline]     pub fn rstart(&mut self) -> _RSTARTW {
        _RSTARTW { w: self }
    }
    #[doc = "Bit 2 - Address Interrupt Enable"]
    #[inline]
#[inline]     pub fn addr(&mut self) -> _ADDRW {
        _ADDRW { w: self }
    }
    #[doc = "Bit 3 - Transfer Completed Interrupt Enable"]
    #[inline]
...
#[inline]     pub fn rxdatav(&mut self) -> _RXDATAVW {
    ...
    #[doc = "Bit 6 - Acknowledge Received Interrupt Enable"]
    #[inline]
#[inline]     pub fn ack(&mut self) -> _ACKW {
        _ACKW { w: self }
    }
    #[doc = "Bit 7 - Not Acknowledge Received Interrupt Enable"]
    #[inline]
#[inline]     pub fn nack(&mut self) -> _NACKW {
        _NACKW { w: self }
    }
    #[doc = "Bit 8 - MSTOP Interrupt Enable"]
    #[inline]
#[inline]     pub fn mstop(&mut self) -> _MSTOPW {
        _MSTOPW { w: self }
    }
    #[doc = "Bit 9 - Arbitration Lost Interrupt Enable"]
    #[inline]
#[inline]     pub fn arblost(&mut self) -> _ARBLOSTW {
        _ARBLOSTW { w: self }
    }
    #[doc = "Bit 10 - Bus Error Interrupt Enable"]
    #[inline]
#[inline]     pub fn buserr(&mut self) -> _BUSERRW {
        _BUSERRW { w: self }
    }
    #[doc = "Bit 11 - Bus Held Interrupt Enable"]
    #[inline]
#[inline]     pub fn bushold(&mut self) -> _BUSHOLDW {
        _BUSHOLDW { w: self }
    }
    #[doc = "Bit 12 - Transmit Buffer Overflow Interrupt Enable"]
    #[inline]
...
#[inline]     pub fn clto(&mut self) -> _CLTOW {
    ...
    #[doc = "Bit 16 - SSTOP Interrupt Enable"]
    #[inline]
#[inline]     pub fn sstop(&mut self) -> _SSTOPW {
        _SSTOPW { w: self }
    }
}
