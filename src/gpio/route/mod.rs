...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn swclkpen(&self) -> SWCLKPENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 0;
    ...
    #[inline]
#[inline]     pub fn swdiopen(&self) -> SWDIOPENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 1;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bit 0 - Serial Wire Clock Pin Enable"]
    #[inline]
#[inline]     pub fn swclkpen(&mut self) -> _SWCLKPENW {
        _SWCLKPENW { w: self }
    }
    #[doc = "Bit 1 - Serial Wire Data Pin Enable"]
    #[inline]
#[inline]     pub fn swdiopen(&mut self) -> _SWDIOPENW {
        _SWDIOPENW { w: self }
    }
}
