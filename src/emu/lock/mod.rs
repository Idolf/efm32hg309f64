...
#[inline]     pub fn bits(&self) -> u16 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u16) -> LOCKKEYR {
        match value {
            0 => LOCKKEYR::UNLOCKED,
            1 => LOCKKEYR::LOCKED,
    ...
    #[inline]
#[inline]     pub fn is_unlocked(&self) -> bool {
...
impl<'a> _LOCKKEYW<'a> {
    ...
    #[inline]
#[inline]     pub fn variant(self, variant: LOCKKEYW) -> &'a mut W {
        unsafe { self.bits(variant._bits()) }
    }
    #[doc = "\"\""]
    #[inline]
#[inline]     pub fn unlocked(self) -> &'a mut W {
        self.variant(LOCKKEYW::UNLOCKED)
    }
    #[doc = "\"\""]
    #[inline]
#[inline]     pub fn locked(self) -> &'a mut W {
...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn lockkey(&self) -> LOCKKEYR {
        LOCKKEYR::_from({
            const MASK: u16 = 65535;
            const OFFSET: u8 = 0;
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bits 0:15 - Configuration Lock Key"]
    #[inline]
#[inline]     pub fn lockkey(&mut self) -> _LOCKKEYW {
        _LOCKKEYW { w: self }
    }
}
