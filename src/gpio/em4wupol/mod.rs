...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> EM4WUPOLR {
        match value {
            1 => EM4WUPOLR::A0,
            4 => EM4WUPOLR::C9,
            8 => EM4WUPOLR::F1,
    ...
    #[inline]
#[inline]     pub fn is_a0(&self) -> bool {
        *self == EM4WUPOLR::A0
    }
    #[doc = "Checks if the value of the field is `C9`"]
    #[inline]
#[inline]     pub fn is_c9(&self) -> bool {
        *self == EM4WUPOLR::C9
    }
...
#[inline]     pub fn is_f2(&self) -> bool {
    ...
    #[inline]
#[inline]     pub fn is_e13(&self) -> bool {
        *self == EM4WUPOLR::E13
    }
    #[doc = "Checks if the value of the field is `C4`"]
    #[inline]
#[inline]     pub fn is_c4(&self) -> bool {
        *self == EM4WUPOLR::C4
    }
}
...
impl<'a> _EM4WUPOLW<'a> {
    ...
    #[inline]
#[inline]     pub fn variant(self, variant: EM4WUPOLW) -> &'a mut W {
        unsafe { self.bits(variant._bits()) }
    }
    #[doc = "Determines polarity on pin A0"]
    #[inline]
#[inline]     pub fn a0(self) -> &'a mut W {
        self.variant(EM4WUPOLW::A0)
    }
    #[doc = "Determines polarity on pin C9"]
    #[inline]
#[inline]     pub fn c9(self) -> &'a mut W {
...
#[inline]     pub fn f2(self) -> &'a mut W {
    ...
    #[doc = "Determines polarity on pin E13"]
    #[inline]
#[inline]     pub fn e13(self) -> &'a mut W {
        self.variant(EM4WUPOLW::E13)
    }
    #[doc = "Determines polarity on pin C4"]
    #[inline]
#[inline]     pub fn c4(self) -> &'a mut W {
        self.variant(EM4WUPOLW::C4)
    }
...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn em4wupol(&self) -> EM4WUPOLR {
        EM4WUPOLR::_from({
            const MASK: u8 = 127;
            const OFFSET: u8 = 0;
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bits 0:6 - EM4 Wake-up Polarity"]
    #[inline]
#[inline]     pub fn em4wupol(&mut self) -> _EM4WUPOLW {
        _EM4WUPOLW { w: self }
    }
}
