...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[inline]
#[inline]     pub fn ch0ens(&mut self) -> _CH0ENSW {
        _CH0ENSW { w: self }
    }
    #[doc = "Bit 1 - Channel 1 Enable Set"]
    #[inline]
#[inline]     pub fn ch1ens(&mut self) -> _CH1ENSW {
        _CH1ENSW { w: self }
    }
    #[doc = "Bit 2 - Channel 2 Enable Set"]
    #[inline]
#[inline]     pub fn ch2ens(&mut self) -> _CH2ENSW {
        _CH2ENSW { w: self }
    }
    #[doc = "Bit 3 - Channel 3 Enable Set"]
    #[inline]
#[inline]     pub fn ch3ens(&mut self) -> _CH3ENSW {
        _CH3ENSW { w: self }
    }
    #[doc = "Bit 4 - Channel 4 Enable Set"]
    #[inline]
#[inline]     pub fn ch4ens(&mut self) -> _CH4ENSW {
        _CH4ENSW { w: self }
    }
    #[doc = "Bit 5 - Channel 5 Enable Set"]
    #[inline]
#[inline]     pub fn ch5ens(&mut self) -> _CH5ENSW {
        _CH5ENSW { w: self }
    }
}
