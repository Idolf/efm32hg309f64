...
#[inline]     pub fn en(&self) -> ENR {
    ...
    #[inline]
#[inline]     pub fn cursink(&self) -> CURSINKR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 1;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn minouttrans(&self) -> MINOUTTRANSR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 2;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn outen(&self) -> OUTENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 3;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn outmode(&self) -> OUTMODER {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 4;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn outenprs(&self) -> OUTENPRSR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 18;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub fn en(&mut self) -> _ENW {
    ...
    #[doc = "Bit 1 - Current Sink Enable"]
    #[inline]
#[inline]     pub fn cursink(&mut self) -> _CURSINKW {
        _CURSINKW { w: self }
    }
    #[doc = "Bit 2 - Minimum Output Transition Enable"]
    #[inline]
#[inline]     pub fn minouttrans(&mut self) -> _MINOUTTRANSW {
        _MINOUTTRANSW { w: self }
    }
    #[doc = "Bit 3 - Output Enable"]
    #[inline]
#[inline]     pub fn outen(&mut self) -> _OUTENW {
        _OUTENW { w: self }
    }
    #[doc = "Bit 4 - Output Modes"]
    #[inline]
#[inline]     pub fn outmode(&mut self) -> _OUTMODEW {
        _OUTMODEW { w: self }
    }
    #[doc = "Bit 18 - PRS Controlled Output Enable"]
    #[inline]
#[inline]     pub fn outenprs(&mut self) -> _OUTENPRSW {
        _OUTENPRSW { w: self }
    }
    #[doc = "Bits 20:22 - IDAC Output PRS channnel Select"]
    #[inline]
