...
#[inline]     pub fn cc2(&self) -> CC2R {
    ...
    #[inline]
#[inline]     pub fn icbof0(&self) -> ICBOF0R {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 8;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn icbof1(&self) -> ICBOF1R {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 9;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn icbof2(&self) -> ICBOF2R {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 10;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bit 0 - Overflow Interrupt Enable"]
    #[inline]
#[inline]     pub fn of(&mut self) -> _OFW {
        _OFW { w: self }
    }
    #[doc = "Bit 1 - Underflow Interrupt Enable"]
    #[inline]
#[inline]     pub fn uf(&mut self) -> _UFW {
        _UFW { w: self }
    }
    #[doc = "Bit 4 - CC Channel 0 Interrupt Enable"]
    #[inline]
#[inline]     pub fn cc0(&mut self) -> _CC0W {
        _CC0W { w: self }
    }
    #[doc = "Bit 5 - CC Channel 1 Interrupt Enable"]
    #[inline]
#[inline]     pub fn cc1(&mut self) -> _CC1W {
        _CC1W { w: self }
    }
    #[doc = "Bit 6 - CC Channel 2 Interrupt Enable"]
    #[inline]
#[inline]     pub fn cc2(&mut self) -> _CC2W {
        _CC2W { w: self }
    }
    #[doc = "Bit 8 - CC Channel 0 Input Capture Buffer Overflow Interrupt Enable"]
    #[inline]
#[inline]     pub fn icbof0(&mut self) -> _ICBOF0W {
        _ICBOF0W { w: self }
    }
    #[doc = "Bit 9 - CC Channel 1 Input Capture Buffer Overflow Interrupt Enable"]
    #[inline]
#[inline]     pub fn icbof1(&mut self) -> _ICBOF1W {
        _ICBOF1W { w: self }
    }
    #[doc = "Bit 10 - CC Channel 2 Input Capture Buffer Overflow Interrupt Enable"]
    #[inline]
#[inline]     pub fn icbof2(&mut self) -> _ICBOF2W {
        _ICBOF2W { w: self }
    }
}
