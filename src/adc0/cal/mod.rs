...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn singleoffset(&self) -> SINGLEOFFSETR {
        let bits = {
            const MASK: u8 = 127;
            const OFFSET: u8 = 0;
    ...
    #[inline]
#[inline]     pub fn singlegain(&self) -> SINGLEGAINR {
        let bits = {
            const MASK: u8 = 127;
            const OFFSET: u8 = 8;
            ((self.bits >> OFFSET) & MASK as u32) as u8
    ...
    #[inline]
#[inline]     pub fn scanoffset(&self) -> SCANOFFSETR {
        let bits = {
            const MASK: u8 = 127;
            const OFFSET: u8 = 16;
            ((self.bits >> OFFSET) & MASK as u32) as u8
    ...
    #[inline]
#[inline]     pub fn scangain(&self) -> SCANGAINR {
        let bits = {
            const MASK: u8 = 127;
            const OFFSET: u8 = 24;
            ((self.bits >> OFFSET) & MASK as u32) as u8
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bits 0:6 - Single Mode Offset Calibration Value"]
    #[inline]
#[inline]     pub fn singleoffset(&mut self) -> _SINGLEOFFSETW {
        _SINGLEOFFSETW { w: self }
    }
    #[doc = "Bits 8:14 - Single Mode Gain Calibration Value"]
    #[inline]
#[inline]     pub fn singlegain(&mut self) -> _SINGLEGAINW {
        _SINGLEGAINW { w: self }
    }
    #[doc = "Bits 16:22 - Scan Mode Offset Calibration Value"]
    #[inline]
#[inline]     pub fn scanoffset(&mut self) -> _SCANOFFSETW {
        _SCANOFFSETW { w: self }
    }
    #[doc = "Bits 24:30 - Scan Mode Gain Calibration Value"]
    #[inline]
#[inline]     pub fn scangain(&mut self) -> _SCANGAINW {
        _SCANGAINW { w: self }
    }
}
