...
#[doc = r" Proxy"]
pub struct _IRQERASEABORTW<'a> {
    w: &'a mut W,
}
impl<'a> _IRQERASEABORTW<'a> {
    #[doc = r" Sets the field bit"]
#[inline]     pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[inline]     pub fn wren(&self) -> WRENR {
    ...
    #[inline]
#[inline]     pub fn irqeraseabort(&self) -> IRQERASEABORTR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 1;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bit 0 - Enable Write/Erase Controller"]
    #[inline]
#[inline]     pub fn wren(&mut self) -> _WRENW {
        _WRENW { w: self }
    }
    #[doc = "Bit 1 - Abort Page Erase on Interrupt"]
    #[inline]
#[inline]     pub fn irqeraseabort(&mut self) -> _IRQERASEABORTW {
        _IRQERASEABORTW { w: self }
    }
}
