...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn erase(&self) -> ERASER {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 0;
    ...
    #[inline]
#[inline]     pub fn write(&self) -> WRITER {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 1;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bit 0 - Erase Done Interrupt Enable"]
    #[inline]
#[inline]     pub fn erase(&mut self) -> _ERASEW {
        _ERASEW { w: self }
    }
    #[doc = "Bit 1 - Write Done Interrupt Enable"]
    #[inline]
#[inline]     pub fn write(&mut self) -> _WRITEW {
        _WRITEW { w: self }
    }
    #[doc = "Bit 2 - Cache Hits Overflow Interrupt Enable"]
    #[inline]
#[inline]     pub fn chof(&mut self) -> _CHOFW {
        _CHOFW { w: self }
    }
    #[doc = "Bit 3 - Cache Misses Overflow Interrupt Enable"]
    #[inline]
#[inline]     pub fn cmof(&mut self) -> _CMOFW {
        _CMOFW { w: self }
    }
}
