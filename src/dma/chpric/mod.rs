...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[inline]
#[inline]     pub fn ch0pric(&mut self) -> _CH0PRICW {
        _CH0PRICW { w: self }
    }
    #[doc = "Bit 1 - Channel 1 High Priority Clear"]
    #[inline]
#[inline]     pub fn ch1pric(&mut self) -> _CH1PRICW {
        _CH1PRICW { w: self }
    }
    #[doc = "Bit 2 - Channel 2 High Priority Clear"]
    #[inline]
#[inline]     pub fn ch2pric(&mut self) -> _CH2PRICW {
        _CH2PRICW { w: self }
    }
    #[doc = "Bit 3 - Channel 3 High Priority Clear"]
    #[inline]
#[inline]     pub fn ch3pric(&mut self) -> _CH3PRICW {
        _CH3PRICW { w: self }
    }
    #[doc = "Bit 4 - Channel 4 High Priority Clear"]
    #[inline]
#[inline]     pub fn ch4pric(&mut self) -> _CH4PRICW {
        _CH4PRICW { w: self }
    }
    #[doc = "Bit 5 - Channel 5 High Priority Clear"]
    #[inline]
#[inline]     pub fn ch5pric(&mut self) -> _CH5PRICW {
        _CH5PRICW { w: self }
    }
}
