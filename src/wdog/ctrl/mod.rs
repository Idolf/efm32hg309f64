...
#[inline]     pub fn debugrun(&self) -> DEBUGRUNR {
    ...
    #[inline]
#[inline]     pub fn em2run(&self) -> EM2RUNR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 2;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn em3run(&self) -> EM3RUNR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 3;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub fn lock(&self) -> LOCKR {
    ...
    #[inline]
#[inline]     pub fn em4block(&self) -> EM4BLOCKR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 5;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn swoscblock(&self) -> SWOSCBLOCKR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 6;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn persel(&self) -> PERSELR {
        let bits = {
            const MASK: u8 = 15;
            const OFFSET: u8 = 8;
...
#[inline]     pub fn debugrun(&mut self) -> _DEBUGRUNW {
    ...
    #[doc = "Bit 2 - Energy Mode 2 Run Enable"]
    #[inline]
#[inline]     pub fn em2run(&mut self) -> _EM2RUNW {
        _EM2RUNW { w: self }
    }
    #[doc = "Bit 3 - Energy Mode 3 Run Enable"]
    #[inline]
#[inline]     pub fn em3run(&mut self) -> _EM3RUNW {
        _EM3RUNW { w: self }
    }
    #[doc = "Bit 4 - Configuration lock"]
    #[inline]
#[inline]     pub fn lock(&mut self) -> _LOCKW {
        _LOCKW { w: self }
    }
    #[doc = "Bit 5 - Energy Mode 4 Block"]
    #[inline]
#[inline]     pub fn em4block(&mut self) -> _EM4BLOCKW {
        _EM4BLOCKW { w: self }
    }
    #[doc = "Bit 6 - Software Oscillator Disable Block"]
    #[inline]
#[inline]     pub fn swoscblock(&mut self) -> _SWOSCBLOCKW {
        _SWOSCBLOCKW { w: self }
    }
    #[doc = "Bits 8:11 - Watchdog Timeout Period Select"]
    #[inline]
#[inline]     pub fn persel(&mut self) -> _PERSELW {
        _PERSELW { w: self }
    }
    #[doc = "Bits 12:13 - Watchdog Clock Select"]
    #[inline]
