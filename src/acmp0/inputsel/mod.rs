...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> POSSELR {
        match value {
            0 => POSSELR::CH0,
            1 => POSSELR::CH1,
            2 => POSSELR::CH2,
...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> NEGSELR {
        match value {
            0 => NEGSELR::CH0,
            1 => NEGSELR::CH1,
            2 => NEGSELR::CH2,
...
#[inline]     pub fn is_vdd(&self) -> bool {
    ...
    #[inline]
#[inline]     pub fn is_capsense(&self) -> bool {
...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> CSRESSELR {
        match value {
            0 => CSRESSELR::RES0,
            1 => CSRESSELR::RES1,
            2 => CSRESSELR::RES2,
...
impl<'a> _POSSELW<'a> {
    ...
    #[inline]
#[inline]     pub fn variant(self, variant: POSSELW) -> &'a mut W {
        {
    ...
    #[doc = "Channel 0 as positive input."]
    #[inline]
#[inline]     pub fn ch0(self) -> &'a mut W {
        self.variant(POSSELW::CH0)
    }
    #[doc = "Channel 1 as positive input."]
    #[inline]
#[inline]     pub fn ch1(self) -> &'a mut W {
        self.variant(POSSELW::CH1)
    }
    #[doc = "Channel 2 as positive input."]
    #[inline]
#[inline]     pub fn ch2(self) -> &'a mut W {
        self.variant(POSSELW::CH2)
    }
    #[doc = "Channel 3 as positive input."]
    #[inline]
#[inline]     pub fn ch3(self) -> &'a mut W {
        self.variant(POSSELW::CH3)
    }
    #[doc = "Channel 4 as positive input."]
    #[inline]
#[inline]     pub fn ch4(self) -> &'a mut W {
        self.variant(POSSELW::CH4)
    }
    #[doc = "Channel 5 as positive input."]
    #[inline]
#[inline]     pub fn ch5(self) -> &'a mut W {
        self.variant(POSSELW::CH5)
    }
    #[doc = "Channel 6 as positive input."]
    #[inline]
#[inline]     pub fn ch6(self) -> &'a mut W {
        self.variant(POSSELW::CH6)
    }
    #[doc = "Channel 7 as positive input."]
    #[inline]
#[inline]     pub fn ch7(self) -> &'a mut W {
...
impl<'a> _NEGSELW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
#[inline]     pub fn variant(self, variant: NEGSELW) -> &'a mut W {
...
#[inline]     pub fn vdd(self) -> &'a mut W {
    ...
    #[doc = "Capacitive sense mode."]
    #[inline]
#[inline]     pub fn capsense(self) -> &'a mut W {
...
impl<'a> _CSRESSELW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
#[inline]     pub fn variant(self, variant: CSRESSELW) -> &'a mut W {
        {
            self.bits(variant._bits())
        }
    }
    #[doc = "Internal capacitive sense resistor value 0."]
    #[inline]
#[inline]     pub fn res0(self) -> &'a mut W {
        self.variant(CSRESSELW::RES0)
    }
    #[doc = "Internal capacitive sense resistor value 1."]
    #[inline]
#[inline]     pub fn res1(self) -> &'a mut W {
        self.variant(CSRESSELW::RES1)
    }
    #[doc = "Internal capacitive sense resistor value 2."]
    #[inline]
#[inline]     pub fn res2(self) -> &'a mut W {
        self.variant(CSRESSELW::RES2)
    }
    #[doc = "Internal capacitive sense resistor value 3."]
    #[inline]
#[inline]     pub fn res3(self) -> &'a mut W {
...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn possel(&self) -> POSSELR {
        POSSELR::_from({
            const MASK: u8 = 7;
            const OFFSET: u8 = 0;
    ...
    #[inline]
#[inline]     pub fn negsel(&self) -> NEGSELR {
        NEGSELR::_from({
            const MASK: u8 = 15;
            const OFFSET: u8 = 4;
            ((self.bits >> OFFSET) & MASK as u32) as u8
    ...
    #[inline]
#[inline]     pub fn vddlevel(&self) -> VDDLEVELR {
        let bits = {
            const MASK: u8 = 63;
            const OFFSET: u8 = 8;
            ((self.bits >> OFFSET) & MASK as u32) as u8
    ...
    #[inline]
#[inline]     pub fn lpref(&self) -> LPREFR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 16;
    ...
    #[inline]
#[inline]     pub fn csresen(&self) -> CSRESENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 24;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn csressel(&self) -> CSRESSELR {
        CSRESSELR::_from({
            const MASK: u8 = 3;
            const OFFSET: u8 = 28;
            ((self.bits >> OFFSET) & MASK as u32) as u8
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bits 0:2 - Positive Input Select"]
    #[inline]
#[inline]     pub fn possel(&mut self) -> _POSSELW {
        _POSSELW { w: self }
    }
    #[doc = "Bits 4:7 - Negative Input Select"]
    #[inline]
#[inline]     pub fn negsel(&mut self) -> _NEGSELW {
        _NEGSELW { w: self }
    }
    #[doc = "Bits 8:13 - VDD Reference Level"]
    #[inline]
#[inline]     pub fn vddlevel(&mut self) -> _VDDLEVELW {
        _VDDLEVELW { w: self }
    }
    #[doc = "Bit 16 - Low Power Reference Mode"]
    #[inline]
#[inline]     pub fn lpref(&mut self) -> _LPREFW {
        _LPREFW { w: self }
    }
    #[doc = "Bit 24 - Capacitive Sense Mode Internal Resistor Enable"]
    #[inline]
#[inline]     pub fn csresen(&mut self) -> _CSRESENW {
        _CSRESENW { w: self }
    }
    #[doc = "Bits 28:29 - Capacitive Sense Mode Internal Resistor Select"]
    #[inline]
#[inline]     pub fn csressel(&mut self) -> _CSRESSELW {
        _CSRESSELW { w: self }
    }
}
