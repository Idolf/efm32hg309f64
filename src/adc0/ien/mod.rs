...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn single(&self) -> SINGLER {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 0;
...
#[inline]     pub fn scan(&self) -> SCANR {
    ...
    #[inline]
#[inline]     pub fn singleof(&self) -> SINGLEOFR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 8;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn scanof(&self) -> SCANOFR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 9;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bit 0 - Single Conversion Complete Interrupt Enable"]
    #[inline]
#[inline]     pub fn single(&mut self) -> _SINGLEW {
        _SINGLEW { w: self }
    }
    #[doc = "Bit 1 - Scan Conversion Complete Interrupt Enable"]
    #[inline]
#[inline]     pub fn scan(&mut self) -> _SCANW {
        _SCANW { w: self }
    }
    #[doc = "Bit 8 - Single Result Overflow Interrupt Enable"]
    #[inline]
#[inline]     pub fn singleof(&mut self) -> _SINGLEOFW {
        _SINGLEOFW { w: self }
    }
    #[doc = "Bit 9 - Scan Result Overflow Interrupt Enable"]
    #[inline]
#[inline]     pub fn scanof(&mut self) -> _SCANOFW {
        _SCANOFW { w: self }
    }
}
