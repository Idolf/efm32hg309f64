...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[inline]
#[inline]     pub fn ch0alts(&mut self) -> _CH0ALTSW {
        _CH0ALTSW { w: self }
    }
    #[doc = "Bit 1 - Channel 1 Alternate Structure Set"]
    #[inline]
#[inline]     pub fn ch1alts(&mut self) -> _CH1ALTSW {
        _CH1ALTSW { w: self }
    }
    #[doc = "Bit 2 - Channel 2 Alternate Structure Set"]
    #[inline]
#[inline]     pub fn ch2alts(&mut self) -> _CH2ALTSW {
        _CH2ALTSW { w: self }
    }
    #[doc = "Bit 3 - Channel 3 Alternate Structure Set"]
    #[inline]
#[inline]     pub fn ch3alts(&mut self) -> _CH3ALTSW {
        _CH3ALTSW { w: self }
    }
    #[doc = "Bit 4 - Channel 4 Alternate Structure Set"]
    #[inline]
#[inline]     pub fn ch4alts(&mut self) -> _CH4ALTSW {
        _CH4ALTSW { w: self }
    }
    #[doc = "Bit 5 - Channel 5 Alternate Structure Set"]
    #[inline]
#[inline]     pub fn ch5alts(&mut self) -> _CH5ALTSW {
        _CH5ALTSW { w: self }
    }
}
