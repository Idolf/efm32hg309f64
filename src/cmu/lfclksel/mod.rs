...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> LFAR {
        match value {
            0 => LFAR::DISABLED,
            1 => LFAR::LFRCO,
            2 => LFAR::LFXO,
...
#[inline]     pub fn is_lfxo(&self) -> bool {
    ...
    #[inline]
#[inline]     pub fn is_hfcoreclklediv2(&self) -> bool {
...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> LFBR {
        match value {
            0 => LFBR::DISABLED,
            1 => LFBR::LFRCO,
            2 => LFBR::LFXO,
...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> LFCR {
        match value {
            0 => LFCR::DISABLED,
            1 => LFCR::LFRCO,
            2 => LFCR::LFXO,
...
impl<'a> _LFAW<'a> {
    ...
    #[inline]
#[inline]     pub fn variant(self, variant: LFAW) -> &'a mut W {
        {
...
#[inline]     pub fn lfxo(self) -> &'a mut W {
    ...
    #[doc = "HFCORECLKLE divided by two or four is selected as LFACLK. The division factor is determined by CMU_CTRL_HFLE and CMU_HFCORECLKDIV_HFCORECLKLEDIV."]
    #[inline]
#[inline]     pub fn hfcoreclklediv2(self) -> &'a mut W {
...
impl<'a> _LFBW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
#[inline]     pub fn variant(self, variant: LFBW) -> &'a mut W {
        {
            self.bits(variant._bits())
        }
    }
...
impl<'a> _LFCW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
#[inline]     pub fn variant(self, variant: LFCW) -> &'a mut W {
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bits 0:1 - Clock Select for LFA"]
    #[inline]
#[inline]     pub fn lfa(&mut self) -> _LFAW {
        _LFAW { w: self }
    }
    #[doc = "Bits 2:3 - Clock Select for LFB"]
    #[inline]
#[inline]     pub fn lfb(&mut self) -> _LFBW {
        _LFBW { w: self }
    }
    #[doc = "Bits 4:5 - Clock Select for LFC"]
    #[inline]
#[inline]     pub fn lfc(&mut self) -> _LFCW {
        _LFCW { w: self }
    }
    #[doc = "Bit 16 - Clock Select for LFA Extended"]
    #[inline]
#[inline]     pub fn lfae(&mut self) -> _LFAEW {
        _LFAEW { w: self }
    }
    #[doc = "Bit 20 - Clock Select for LFB Extended"]
    #[inline]
#[inline]     pub fn lfbe(&mut self) -> _LFBEW {
        _LFBEW { w: self }
    }
}
