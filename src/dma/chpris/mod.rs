...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[inline]
#[inline]     pub fn ch0pris(&mut self) -> _CH0PRISW {
        _CH0PRISW { w: self }
    }
    #[doc = "Bit 1 - Channel 1 High Priority Set"]
    #[inline]
#[inline]     pub fn ch1pris(&mut self) -> _CH1PRISW {
        _CH1PRISW { w: self }
    }
    #[doc = "Bit 2 - Channel 2 High Priority Set"]
    #[inline]
#[inline]     pub fn ch2pris(&mut self) -> _CH2PRISW {
        _CH2PRISW { w: self }
    }
    #[doc = "Bit 3 - Channel 3 High Priority Set"]
    #[inline]
#[inline]     pub fn ch3pris(&mut self) -> _CH3PRISW {
        _CH3PRISW { w: self }
    }
    #[doc = "Bit 4 - Channel 4 High Priority Set"]
    #[inline]
#[inline]     pub fn ch4pris(&mut self) -> _CH4PRISW {
        _CH4PRISW { w: self }
    }
    #[doc = "Bit 5 - Channel 5 High Priority Set"]
    #[inline]
#[inline]     pub fn ch5pris(&mut self) -> _CH5PRISW {
        _CH5PRISW { w: self }
    }
}
