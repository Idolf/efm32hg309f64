...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn rxdatap0(&self) -> RXDATAP0R {
        let bits = {
            const MASK: u16 = 511;
            const OFFSET: u8 = 0;
    ...
    #[inline]
#[inline]     pub fn perrp0(&self) -> PERRP0R {
        let bits = {
    ...
    #[inline]
#[inline]     pub fn ferrp0(&self) -> FERRP0R {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 15;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn rxdatap1(&self) -> RXDATAP1R {
        let bits = {
            const MASK: u16 = 511;
            const OFFSET: u8 = 16;
            ((self.bits >> OFFSET) & MASK as u32) as u16
    ...
    #[inline]
#[inline]     pub fn perrp1(&self) -> PERRP1R {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 30;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn ferrp1(&self) -> FERRP1R {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 31;
            ((self.bits >> OFFSET) & MASK as u32) != 0
