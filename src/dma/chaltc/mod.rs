...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[inline]
#[inline]     pub fn ch0altc(&mut self) -> _CH0ALTCW {
        _CH0ALTCW { w: self }
    }
    #[doc = "Bit 1 - Channel 1 Alternate Clear"]
    #[inline]
#[inline]     pub fn ch1altc(&mut self) -> _CH1ALTCW {
        _CH1ALTCW { w: self }
    }
    #[doc = "Bit 2 - Channel 2 Alternate Clear"]
    #[inline]
#[inline]     pub fn ch2altc(&mut self) -> _CH2ALTCW {
        _CH2ALTCW { w: self }
    }
    #[doc = "Bit 3 - Channel 3 Alternate Clear"]
    #[inline]
#[inline]     pub fn ch3altc(&mut self) -> _CH3ALTCW {
        _CH3ALTCW { w: self }
    }
    #[doc = "Bit 4 - Channel 4 Alternate Clear"]
    #[inline]
#[inline]     pub fn ch4altc(&mut self) -> _CH4ALTCW {
        _CH4ALTCW { w: self }
    }
    #[doc = "Bit 5 - Channel 5 Alternate Clear"]
    #[inline]
#[inline]     pub fn ch5altc(&mut self) -> _CH5ALTCW {
        _CH5ALTCW { w: self }
    }
}
