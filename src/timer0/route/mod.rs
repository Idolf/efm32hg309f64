...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> LOCATIONR {
        match value {
            0 => LOCATIONR::LOC0,
            1 => LOCATIONR::LOC1,
            2 => LOCATIONR::LOC2,
    ...
    #[inline]
#[inline]     pub fn is_loc0(&self) -> bool {
        *self == LOCATIONR::LOC0
    }
    #[doc = "Checks if the value of the field is `LOC1`"]
    #[inline]
#[inline]     pub fn is_loc1(&self) -> bool {
        *self == LOCATIONR::LOC1
    }
    #[doc = "Checks if the value of the field is `LOC2`"]
    #[inline]
#[inline]     pub fn is_loc2(&self) -> bool {
        *self == LOCATIONR::LOC2
    }
    #[doc = "Checks if the value of the field is `LOC3`"]
    #[inline]
#[inline]     pub fn is_loc3(&self) -> bool {
        *self == LOCATIONR::LOC3
    }
    #[doc = "Checks if the value of the field is `LOC4`"]
    #[inline]
#[inline]     pub fn is_loc4(&self) -> bool {
        *self == LOCATIONR::LOC4
    }
    #[doc = "Checks if the value of the field is `LOC5`"]
    #[inline]
#[inline]     pub fn is_loc5(&self) -> bool {
        *self == LOCATIONR::LOC5
    }
    #[doc = "Checks if the value of the field is `LOC6`"]
    #[inline]
#[inline]     pub fn is_loc6(&self) -> bool {
        *self == LOCATIONR::LOC6
    }
}
#[doc = r" Proxy"]
...
impl<'a> _LOCATIONW<'a> {
    ...
    #[inline]
#[inline]     pub fn variant(self, variant: LOCATIONW) -> &'a mut W {
        unsafe { self.bits(variant._bits()) }
    }
    #[doc = "Location 0"]
    #[inline]
#[inline]     pub fn loc0(self) -> &'a mut W {
        self.variant(LOCATIONW::LOC0)
    }
    #[doc = "Location 1"]
    #[inline]
#[inline]     pub fn loc1(self) -> &'a mut W {
        self.variant(LOCATIONW::LOC1)
    }
    #[doc = "Location 2"]
    #[inline]
#[inline]     pub fn loc2(self) -> &'a mut W {
        self.variant(LOCATIONW::LOC2)
    }
    #[doc = "Location 3"]
    #[inline]
#[inline]     pub fn loc3(self) -> &'a mut W {
        self.variant(LOCATIONW::LOC3)
    }
    #[doc = "Location 4"]
    #[inline]
#[inline]     pub fn loc4(self) -> &'a mut W {
        self.variant(LOCATIONW::LOC4)
    }
    #[doc = "Location 5"]
    #[inline]
#[inline]     pub fn loc5(self) -> &'a mut W {
        self.variant(LOCATIONW::LOC5)
    }
    #[doc = "Location 6"]
    #[inline]
#[inline]     pub fn loc6(self) -> &'a mut W {
...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn cc0pen(&self) -> CC0PENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 0;
    ...
    #[inline]
#[inline]     pub fn cc1pen(&self) -> CC1PENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 1;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn cc2pen(&self) -> CC2PENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 2;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn cdti0pen(&self) -> CDTI0PENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 8;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn cdti1pen(&self) -> CDTI1PENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 9;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn cdti2pen(&self) -> CDTI2PENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 10;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn location(&self) -> LOCATIONR {
        LOCATIONR::_from({
            const MASK: u8 = 7;
            const OFFSET: u8 = 16;
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bit 0 - CC Channel 0 Pin Enable"]
    #[inline]
#[inline]     pub fn cc0pen(&mut self) -> _CC0PENW {
        _CC0PENW { w: self }
    }
    #[doc = "Bit 1 - CC Channel 1 Pin Enable"]
    #[inline]
#[inline]     pub fn cc1pen(&mut self) -> _CC1PENW {
        _CC1PENW { w: self }
    }
    #[doc = "Bit 2 - CC Channel 2 Pin Enable"]
    #[inline]
#[inline]     pub fn cc2pen(&mut self) -> _CC2PENW {
        _CC2PENW { w: self }
    }
    #[doc = "Bit 8 - CC Channel 0 Complementary Dead-Time Insertion Pin Enable"]
    #[inline]
#[inline]     pub fn cdti0pen(&mut self) -> _CDTI0PENW {
        _CDTI0PENW { w: self }
    }
    #[doc = "Bit 9 - CC Channel 1 Complementary Dead-Time Insertion Pin Enable"]
    #[inline]
#[inline]     pub fn cdti1pen(&mut self) -> _CDTI1PENW {
        _CDTI1PENW { w: self }
    }
    #[doc = "Bit 10 - CC Channel 2 Complementary Dead-Time Insertion Pin Enable"]
    #[inline]
#[inline]     pub fn cdti2pen(&mut self) -> _CDTI2PENW {
        _CDTI2PENW { w: self }
    }
    #[doc = "Bits 16:18 - I/O Location"]
    #[inline]
#[inline]     pub fn location(&mut self) -> _LOCATIONW {
        _LOCATIONW { w: self }
    }
}
