...
#[doc = r" Proxy"]
pub struct _RSTPDWNMODULEW<'a> {
    w: &'a mut W,
}
impl<'a> _RSTPDWNMODULEW<'a> {
    #[doc = r" Sets the field bit"]
#[inline]     pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn stoppclk(&self) -> STOPPCLKR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 0;
    ...
    #[doc = "Bit 1 - Gate HCLK"]
    #[inline]
#[inline]     pub fn gatehclk(&self) -> GATEHCLKR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 1;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn pwrclmp(&self) -> PWRCLMPR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 2;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn rstpdwnmodule(&self) -> RSTPDWNMODULER {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 3;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn physleep(&self) -> PHYSLEEPR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 6;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bit 0 - Stop PHY clock"]
    #[inline]
#[inline]     pub fn stoppclk(&mut self) -> _STOPPCLKW {
        _STOPPCLKW { w: self }
    }
    #[doc = "Bit 1 - Gate HCLK"]
    #[inline]
#[inline]     pub fn gatehclk(&mut self) -> _GATEHCLKW {
        _GATEHCLKW { w: self }
    }
    #[doc = "Bit 2 - Power Clamp"]
    #[inline]
#[inline]     pub fn pwrclmp(&mut self) -> _PWRCLMPW {
        _PWRCLMPW { w: self }
    }
    #[doc = "Bit 3 - Reset Power-Down Modules"]
    #[inline]
#[inline]     pub fn rstpdwnmodule(&mut self) -> _RSTPDWNMODULEW {
        _RSTPDWNMODULEW { w: self }
    }
}
