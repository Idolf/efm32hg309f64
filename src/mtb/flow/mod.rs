...
impl<'a> _WATERMARKW<'a> {
    #[doc = r" Writes raw bits to the field"]
    #[inline]
#[inline]     pub unsafe fn bits(self, value: u32) -> &'a mut W {
...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn autostop(&self) -> AUTOSTOPR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 0;
    ...
    #[inline]
#[inline]     pub fn autohalt(&self) -> AUTOHALTR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 1;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn watermark(&self) -> WATERMARKR {
        let bits = {
            const MASK: u32 = 536870911;
            const OFFSET: u8 = 3;
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bit 0 - AUTOSTOP enable."]
    #[inline]
#[inline]     pub fn autostop(&mut self) -> _AUTOSTOPW {
        _AUTOSTOPW { w: self }
    }
    #[doc = "Bit 1 - AUTOHALT enable."]
    #[inline]
#[inline]     pub fn autohalt(&mut self) -> _AUTOHALTW {
        _AUTOHALTW { w: self }
    }
    #[doc = "Bits 3:31 - WATERMARK value."]
    #[inline]
#[inline]     pub fn watermark(&mut self) -> _WATERMARKW {
        _WATERMARKW { w: self }
    }
}
