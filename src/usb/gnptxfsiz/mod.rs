...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn nptxfstaddr(&self) -> NPTXFSTADDRR {
        let bits = {
            const MASK: u16 = 1023;
            const OFFSET: u8 = 0;
    ...
    #[inline]
#[inline]     pub fn nptxfineptxf0dep(&self) -> NPTXFINEPTXF0DEPR {
        let bits = {
            const MASK: u16 = 65535;
            const OFFSET: u8 = 16;
            ((self.bits >> OFFSET) & MASK as u32) as u16
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bits 0:9 - Non-periodic Transmit RAM Start Address host only"]
    #[inline]
#[inline]     pub fn nptxfstaddr(&mut self) -> _NPTXFSTADDRW {
        _NPTXFSTADDRW { w: self }
    }
    #[doc = "Bits 16:31 - Non-periodic TxFIFO Depth host only / IN Endpoint TxFIFO 0 Depth"]
    #[inline]
#[inline]     pub fn nptxfineptxf0dep(&mut self) -> _NPTXFINEPTXF0DEPW {
