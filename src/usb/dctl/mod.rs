...
#[inline]     pub fn bits(&self) -> u8 {
    ...
    #[doc(hidden)]
    #[inline]
#[inline]     pub fn _from(value: u8) -> TSTCTLR {
        match value {
            0 => TSTCTLR::DISABLE,
            1 => TSTCTLR::J,
            2 => TSTCTLR::K,
...
impl<'a> _TSTCTLW<'a> {
    ...
    #[inline]
#[inline]     pub fn variant(self, variant: TSTCTLW) -> &'a mut W {
...
#[inline]     pub fn disable(self) -> &'a mut W {
    ...
    #[doc = "Test_J mode."]
    #[inline]
#[inline]     pub fn j(self) -> &'a mut W {
        self.variant(TSTCTLW::J)
    }
    #[doc = "Test_K mode."]
    #[inline]
#[inline]     pub fn k(self) -> &'a mut W {
        self.variant(TSTCTLW::K)
    }
    #[doc = "Test_SE0_NAK mode."]
    #[inline]
#[inline]     pub fn se0nak(self) -> &'a mut W {
        self.variant(TSTCTLW::SE0NAK)
    }
    #[doc = "Test_Packet mode."]
    #[inline]
#[inline]     pub fn packet(self) -> &'a mut W {
        self.variant(TSTCTLW::PACKET)
    }
    #[doc = "Test_Force_Enable."]
    #[inline]
#[inline]     pub fn force(self) -> &'a mut W {
...
#[inline]     pub fn bits(&self) -> u32 {
    ...
    #[inline]
#[inline]     pub fn rmtwkupsig(&self) -> RMTWKUPSIGR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 0;
    ...
    #[inline]
#[inline]     pub fn sftdiscon(&self) -> SFTDISCONR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 1;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn gnpinnaksts(&self) -> GNPINNAKSTSR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 2;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn goutnaksts(&self) -> GOUTNAKSTSR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 3;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn tstctl(&self) -> TSTCTLR {
        TSTCTLR::_from({
            const MASK: u8 = 7;
            const OFFSET: u8 = 4;
    ...
    #[inline]
#[inline]     pub fn pwronprgdone(&self) -> PWRONPRGDONER {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 11;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn ignrfrmnum(&self) -> IGNRFRMNUMR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 15;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
#[inline]     pub fn nakonbble(&self) -> NAKONBBLER {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 16;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
#[inline]     pub unsafe fn bits(&mut self, bits: u32) -> &mut Self {
    ...
    #[doc = "Bit 0 - Remote Wakeup Signaling"]
    #[inline]
#[inline]     pub fn rmtwkupsig(&mut self) -> _RMTWKUPSIGW {
        _RMTWKUPSIGW { w: self }
    }
    #[doc = "Bit 1 - Soft Disconnect"]
    #[inline]
#[inline]     pub fn sftdiscon(&mut self) -> _SFTDISCONW {
        _SFTDISCONW { w: self }
    }
    #[doc = "Bits 4:6 - Test Control"]
    #[inline]
#[inline]     pub fn tstctl(&mut self) -> _TSTCTLW {
        _TSTCTLW { w: self }
    }
    #[doc = "Bit 7 - Set Global Non-periodic IN NAK"]
    #[inline]
#[inline]     pub fn sgnpinnak(&mut self) -> _SGNPINNAKW {
        _SGNPINNAKW { w: self }
    }
    #[doc = "Bit 8 - Clear Global Non-periodic IN NAK"]
    #[inline]
#[inline]     pub fn cgnpinnak(&mut self) -> _CGNPINNAKW {
        _CGNPINNAKW { w: self }
    }
    #[doc = "Bit 9 - Set Global OUT NAK"]
    #[inline]
#[inline]     pub fn sgoutnak(&mut self) -> _SGOUTNAKW {
        _SGOUTNAKW { w: self }
    }
    #[doc = "Bit 10 - Clear Global OUT NAK"]
    #[inline]
#[inline]     pub fn cgoutnak(&mut self) -> _CGOUTNAKW {
        _CGOUTNAKW { w: self }
    }
    #[doc = "Bit 11 - Power-On Programming Done"]
    #[inline]
#[inline]     pub fn pwronprgdone(&mut self) -> _PWRONPRGDONEW {
        _PWRONPRGDONEW { w: self }
    }
    #[doc = "Bit 15 - Ignore Frame number For Isochronous End points"]
    #[inline]
#[inline]     pub fn ignrfrmnum(&mut self) -> _IGNRFRMNUMW {
        _IGNRFRMNUMW { w: self }
    }
    #[doc = "Bit 16 - NAK on Babble Error"]
    #[inline]
#[inline]     pub fn nakonbble(&mut self) -> _NAKONBBLEW {
        _NAKONBBLEW { w: self }
    }
}
